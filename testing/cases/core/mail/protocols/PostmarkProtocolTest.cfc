<cfcomponent extends="coldbox.system.testing.BaseTestCase" output="false">
	...
	<cffunction name="setup" access="public" output="false" returntype="void">
		<cfscript>
			...
			protocol =  getMockBox().createMock(className="coldbox.system.core.mail.protocols.postmarkProtocol").init(props);
		</cfscript>
	</cffunction>
	...
	<cffunction name="testInitWithoutCorrectProperties" access="public" output="false" returntype="void" mxunit:expectedException="EmailProtocol.PropertyNotFound">
		<cfscript>
