...
<cfcomponent name="securityTest" extends="coldbox.system.extras.baseTest" output="false">
	...
	<cffunction name="testPlugin" access="public" returntype="void" output="false">
		...
		<cfscript>
			...
			assertTrue( isStruct(application.cbAppStorage), "Application storage check");
	...
	<cffunction name="testMethods" access="public" returntype="void" output="false">
		...
		<cfscript>
			...
			plugin.clearAll();
			AssertTrue( structISEmpty(application.cbAppStorage), "Clear & Test" );
		</cfscript>
	</cffunction>
	...
	<cffunction name="tearDown" output="false" access="public" returntype="void" hint="">
		<cfscript>
		structDelete(application,"cbAppStorage");
		</cfscript>
	</cffunction>
