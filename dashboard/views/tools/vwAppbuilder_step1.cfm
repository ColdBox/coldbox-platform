...
<fieldset>
 ...
 <tr onMouseOver="getHint('appname')" onMouseOut="resetHint()">
    ...
    <tr bgcolor="##ffffff" onMouseOver="getHint('appmapping')" onMouseOut="resetHint()">
    	...
    	<td>
    	<input type="text" name="appmapping" id="appmapping" value="" size="40"> <a href="javascript:openBrowser('#Event.getValue("xehFileBrowser")#','appmapping')" title="Select from web root"><img id="appmapping_img" src="images/icons/folder.png" border="0" align="absmiddle" title="Select from web root"></a>
    	</td>
    </tr>
