...
<cfscript>
	...
	function creationTest(){
		adapter.init(definitionFile="coldbox.test.specs.ioc.adapters.resources.WireBox");
		...
		parent.init(definitionFile="coldbox.test.specs.ioc.adapters.resources.WireBox");
