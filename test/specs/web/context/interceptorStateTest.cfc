<cfcomponent extends="coldbox.system.testing.BaseModelTest">
	...
	<cffunction name="setUp" returntype="void" access="public">
		<cfscript>
			...
			this.mock = getMockBox().createMock("coldbox.test.resources.MockInterceptor");
			this.mock2 = getMockBox().createMock("coldbox.test.resources.MockInterceptor");
	...
	<cffunction name="testInvoker" access="public" returnType="void">
		<cfscript>
			...
			this.state.unregister( this.key );
			mockMetadata = { async=false, asyncPriority = "normal", eventPattern = "" };
			mockInterceptor = getMockBox().createMock("coldbox.test.resources.MockInterceptor").$("unittest");
