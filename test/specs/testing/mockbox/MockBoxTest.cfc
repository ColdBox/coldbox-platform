<cfcomponent extends="coldbox.system.testing.BaseSpec" displayname="MockBox Suite">
	...
	<cfscript>
		...
		function setup(){
			test = getMockBox().createEmptyMock( "coldbox.test.specs.testing.resources.Test" );
		}
		
		function testMockRealMethods(){
			Test = getMockBox().createMock( "coldbox.test.specs.testing.resources.Test" );
			test.getData();
		...
		function testSpys(){
			Test = createObject( "component", "coldbox.test.specs.testing.resources.Test" );
		...
		function testCollaborator(){
			Test = createObject( "component", "coldbox.test.specs.testing.resources.Test" );
			mockCollaborator = getMockBox().createMock( className="coldbox.test.specs.testing.resources.Collaborator", 
		                                             callLogging=true );
		...
		function testContainsCFKeyword(){
			test = getMockBox().createMock("coldbox.test.specs.testing.resources.Test");
			mockTest = getMockBox().createEmptyMock( "coldbox.test.specs.testing.resources.ContainsTest" )
				.$("contains", true);
		...
		function testInterfaceContracts(){
			mock = getMockBox().createMock( "coldbox.test.specs.testing.resources.MyInterfaceMock" );
