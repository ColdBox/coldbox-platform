...
<cfset Test = mockBox.createMock("coldbox.test.specs.testing.resources.Test")>
...
<cfset Test = createObject("component","coldbox.test.specs.testing.resources.Test")>
...
<cfset Test = createObject("component","coldbox.test.specs.testing.resources.Test")>
<cfset mockCollaborator = MockBox.createMock(className="coldbox.test.specs.testing.resources.Collaborator",callLogging=true)>
