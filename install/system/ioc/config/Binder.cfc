...
<cfcomponent output="false" hint="This is a WireBox configuration binder object.  You can use it to configure a WireBox injector instance using our WireBox Mapping DSL">
	...
	<cfscript>
		...
		DEFAULTS = {
			//LogBox Defaults
			logBoxConfig = "shared.frameworks.coldbox_3_00.system.ioc.config.LogBox",
			// Scope Defaults
			scopeRegistration = {
				enabled = false,
				scope = "application",
			...
			cacheBox = {
				...
				configFile = "",
				cacheFactory = "",
				classNamespace = "shared.frameworks.coldbox_3_00.system.cache"
			}
		};
	...
	<cffunction name="init" output="false" access="public" returntype="Binder" hint="Constructor: You can pass a data CFC instance, data CFC path or nothing at all for purely programmatic configuration">
		<cfargument name="injector" 	required="true" 	hint="The Injector this binder is bound to" colddoc:generic="shared.frameworks.coldbox_3_00.system.ioc.Injector">
	...
	<!--- getInjector --->
    <cffunction name="getInjector" output="false" access="public" returntype="any" hint="Get the bounded injector for this binder" colddoc:generic="shared.frameworks.coldbox_3_00.system.ioc.Injector">
    	<cfreturn instance.injector>
    </cffunction>
	
	<!--- getColdBox --->
    <cffunction name="getColdBox" output="false" access="public" returntype="any" hint="Get the bounded ColdBox context for this binder, if any" colddoc:generic="shared.frameworks.coldbox_3_00.system.web.Controller">
...
<!------------------------------------------- MAPPING METHODS ------------------------------------------>
	...
	<!--- getMapping --->
    <cffunction name="getMapping" output="false" access="public" returntype="any" hint="Get a specific object mapping: shared.frameworks.coldbox_3_00.system.ioc.config.Mapping" colddoc:generic="shared.frameworks.coldbox_3_00.system.ioc.config.Mapping">
...
<!------------------------------------------- MAPPING DSL ------------------------------------------>
    ...
    <cffunction name="map" output="false" access="public" returntype="any" hint="Create a mapping to an object">
		...
		<cfscript>
			...
			instance.mappings[ name ] = createObject("component","shared.frameworks.coldbox_3_00.system.ioc.config.Mapping").init( name );
	...
	<!--- toProvider --->
    <cffunction name="toProvider" output="false" access="public" returntype="any" hint="Map to a provider object that must implement shared.frameworks.coldbox_3_00.system.ioc.IProvider">
...
<!------------------------------------------- CACHEBOX INTEGRATION ------------------------------------------>
    ...
    <cffunction name="cacheBox" output="false" access="public" returntype="any" hint="Integrate with CacheBox">
    	...
    	<cfargument name="classNamespace" 	required="false" default="#DEFAULTS.cachebox.classNamespace#" hint="The package namespace to use for creating or connecting to CacheBox. Defaults to: shared.frameworks.coldbox_3_00.system.cache"/>
...
<!------------------------------------------- MAP DSL ------------------------------------------>
    ...
    <cffunction name="mapDSL" output="false" access="public" returntype="any" hint="Register a new custom dsl namespace">
		...
		<cfargument name="path" 		required="true" hint="The instantiation path to the CFC that implements this scope, it must have an init() method and implement: shared.frameworks.coldbox_3_00.system.ioc.dsl.IDSLBuilder"/>
...
<!------------------------------------------- MAP SCOPES ------------------------------------------>
    ...
    <cffunction name="mapScope" output="false" access="public" returntype="any" hint="Register a new WireBox custom scope">
    	...
    	<cfargument name="path" 		required="true" hint="The path to the CFC that implements this scope, it must have an init() method and implement: shared.frameworks.coldbox_3_00.system.ioc.scopes.IScope"/>
