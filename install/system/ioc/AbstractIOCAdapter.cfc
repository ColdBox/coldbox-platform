...
<!----------------------------------------- CONCRETE PUBLIC ------------------------------------->	
	...
	<!--- getColdBox --->
	<cffunction name="getColdBox" access="public" output="false" returntype="any" hint="Get the ColdBox controller this adapter is linked to. If not linked and exception is thrown" colddoc:generic="shared.frameworks.coldbox_3_00.system.web.Controller">
