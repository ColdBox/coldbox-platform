...
Description :
	...
	<!-- ColdboxFactory -->
	<bean id="ColdboxFactory" class="shared.frameworks.coldbox_3_00.system.ioc.ColdboxFactory" />
...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<!--- The beans paths --->
	<cfscript>
		variables.configBeanPath 		= "shared.frameworks.coldbox_3_00.system.core.collections.ConfigBean";
		variables.datasourceBeanPath 	= "shared.frameworks.coldbox_3_00.system.core.db.DatasourceBean";
		variables.mailsettingsBeanPath 	= "shared.frameworks.coldbox_3_00.system.core.mail.MailSettingsBean";
...
<!------------------------------------------- HELPERS ------------------------------------------->
	...
	<!--- Get a config bean --->
	<cffunction name="getConfigBean" output="false" access="public" returntype="shared.frameworks.coldbox_3_00.system.core.collections.ConfigBean" hint="Returns an application's config bean: shared.frameworks.coldbox_3_00.system.core.collections.ConfigBean">
		<cfscript>
	...
	<cffunction name="getColdbox" output="false" access="public" returntype="shared.frameworks.coldbox_3_00.system.web.Controller" hint="Get the coldbox controller reference: shared.frameworks.coldbox_3_00.system.web.Controller">
		<cfreturn application[coldboxAppKey]>
	</cffunction>
	
	<!--- Get the cachebox instance --->
	<cffunction name="getCacheBox" output="false" access="public" returntype="any" hint="Get the CacheBox reference." colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.CacheFactory">
		<cfreturn getColdbox().getCacheBox()>
	</cffunction>
	
	<!--- Get the wirebox configured on this app --->
	<cffunction name="getWireBox" output="false" access="public" returntype="shared.frameworks.coldbox_3_00.system.ioc.Injector" hint="Get the WireBox Injector reference.">
	...
	<cffunction name="getLogBox" output="false" access="public" returntype="shared.frameworks.coldbox_3_00.system.logging.LogBox" hint="Get the LogBox reference.">
		<cfreturn getColdbox().getLogBox()>
	</cffunction>
	
	<!--- Get the app's root Logger --->
	<cffunction name="getRootLogger" output="false" access="public" returntype="shared.frameworks.coldbox_3_00.system.logging.Logger" hint="Get the root logger reference.">
		<cfreturn getLogBox().getRootLogger()>
	</cffunction>
	
	<!--- Get a logger --->
	<cffunction name="getLogger" output="false" access="public" returntype="shared.frameworks.coldbox_3_00.system.logging.Logger" hint="Get a named logger reference.">
	...
	<!--- Get Context Facade --->
	<cffunction name="getRequestContext" access="public" returntype="shared.frameworks.coldbox_3_00.system.web.context.RequestContext" hint="Tries to retrieve the request context object" output="false" >
	...
	<cffunction name="getColdboxOCM" access="public" output="false" returntype="any" hint="Get ColdboxOCM: shared.frameworks.coldbox_3_00.system.cache.CacheManager or new CacheBox providers as shared.frameworks.coldbox_3_00.system.cache.IColdboxApplicationCache" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.IColdboxApplicationCache">
	...
	<!--- Get a datasource --->
	<cffunction name="getDatasource" access="public" output="false" returnType="shared.frameworks.coldbox_3_00.system.core.db.DatasourceBean" hint="I will return to you a datasourceBean according to the alias of the datasource you wish to get from the configstruct: shared.frameworks.coldbox_3_00.system.core.db.DatasourceBean">
		<!--- ************************************************************* --->
	...
	<cffunction name="getMailSettings" access="public" output="false" returnType="shared.frameworks.coldbox_3_00.system.core.mail.MailSettingsBean" hint="I will return to you a mailsettingsBean modeled after your mail settings in your config file.">
