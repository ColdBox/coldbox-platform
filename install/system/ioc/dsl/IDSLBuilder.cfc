...
<cfinterface hint="The main interface to produce WireBox namespace DSL Builders">
	...
	<!--- init --->
    <cffunction name="init" output="false" access="public" returntype="any" hint="Configure the DSL Builder for operation and returns itself" colddoc:generic="shared.frameworks.coldbox_3_00.system.ioc.dsl.IDSLBuilder">
