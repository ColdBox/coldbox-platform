...
----------------------------------------------------------------------->
<cfcomponent hint="The DSL builder for all ColdBox related stuff" implements="shared.frameworks.coldbox_3_00.system.ioc.dsl.IDSLBuilder" output="false">

	<!--- init --->
    <cffunction name="init" output="false" access="public" returntype="any" hint="Configure the DSL for operation and returns itself" colddoc:generic="shared.frameworks.coldbox_3_00.system.ioc.dsl.IDSLBuilder">
	...
	<cffunction name="getDatasource" access="private" output="false" returnType="any" hint="I will return to you a datasourceBean according to the alias of the datasource you wish to get from the configstruct" colddoc:generic="shared.frameworks.coldbox_3_00.system.core.db.DatasourceBean">
		...
		if ( structKeyExists(datasources, arguments.alias) ){
			return createObject("component","shared.frameworks.coldbox_3_00.system.core.db.DatasourceBean").init(datasources[arguments.alias]);
		}
		</cfscript>
	</cffunction>
	...
	<cffunction name="getEntityServiceDSL" access="private" returntype="any" hint="Get a virtual entity service object" output="false" >
		...
		<cfscript>
			...
			if( len(entityName) ){
				return createObject("component","shared.frameworks.coldbox_3_00.system.orm.hibernate.VirtualEntityService").init( entityName );
			}

			// else Return Base ORM Service
			return createObject("component","shared.frameworks.coldbox_3_00.system.orm.hibernate.BaseORMService").init();
		</cfscript>
	</cffunction>
			...
			switch(thisTypeLen){
				...
				case 2: {
					...
					switch( thisLocationKey ){
						case "fwconfigbean" 		: { return createObject("component","shared.frameworks.coldbox_3_00.system.core.collections.ConfigBean").init( instance.coldbox.getColdboxSettings() ); }
						case "configbean" 			: { return createObject("component","shared.frameworks.coldbox_3_00.system.core.collections.ConfigBean").init( instance.coldbox.getConfigSettings() ); }
						case "mailsettingsbean"		: { 
							return createObject("component","shared.frameworks.coldbox_3_00.system.core.mail.MailSettingsBean").init(instance.coldbox.getSetting("MailServer"),
