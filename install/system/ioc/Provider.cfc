...
----------------------------------------------------------------------->
<cfcomponent implements="shared.frameworks.coldbox_3_00.system.ioc.IProvider" hint="A WireBox provider object that retrieves objects by using the provider pattern." output="false">
	
	<!--- init --->
    <cffunction name="init" output="false" access="public" returntype="Provider" hint="Constructor">
    	<cfargument name="injector" required="true" hint="The injector linkage of this provider" colddoc:generic="shared.frameworks.coldbox_3_00.system.ioc.Injector"/>
