...
----------------------------------------------------------------------->
<cfcomponent output="false" implements="shared.frameworks.coldbox_3_00.system.ioc.scopes.IScope" hint="I am a scope that talks to CacheBox">

	<!--- init --->
    <cffunction name="init" output="false" access="public" returntype="any" hint="Configure the scope for operation">
    	<cfargument name="injector" type="any" required="true" hint="The linked WireBox injector: shared.frameworks.coldbox_3_00.system.ioc.Injector" colddoc:generic="shared.frameworks.coldbox_3_00.system.ioc.Injector"/>
		<cfscript>
			instance = {
    ...
    <cffunction name="getFromScope" output="false" access="public" returntype="any" hint="Retrieve an object from scope or create it if not found in scope">
    	<cfargument name="mapping" 			type="any" required="true" hint="The object mapping: shared.frameworks.coldbox_3_00.system.ioc.config.Mapping" colddoc:generic="shared.frameworks.coldbox_3_00.system.ioc.config.Mapping"/>
