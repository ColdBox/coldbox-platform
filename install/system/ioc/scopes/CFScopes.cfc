...
----------------------------------------------------------------------->
<cfcomponent output="false" implements="shared.frameworks.coldbox_3_00.system.ioc.scopes.IScope" hint="I am a scopes that stores in valid CF scopes">
    ...
    <cffunction name="init" output="false" access="public" returntype="any" hint="Configure the scope for operation">
    	...
    	<cfscript>
			instance = {
				...
				scopeStorage = createObject("component","shared.frameworks.coldbox_3_00.system.core.collections.ScopeStorage").init(), 
