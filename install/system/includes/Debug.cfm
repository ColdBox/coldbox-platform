...
<div class="fw_debugPanel">
	...
	<!--- TRACER STACK--->
	<!--- **************************************************************--->
	<cfinclude template="/shared/frameworks/coldbox_3_00/system/includes/panels/TracersPanel.cfm">
...
<!--- **************************************************************--->
	...
	<div class="fw_debugContent<cfif getDebuggerConfig().getExpandedRCPanel()>View</cfif>" id="fw_reqCollection">
		...
		<cfinclude template="/shared/frameworks/coldbox_3_00/system/includes/panels/CollectionPanel.cfm">
		<!--- Private Collection --->
