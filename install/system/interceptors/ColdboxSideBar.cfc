...
----------------------------------------------------------------------->
<cfcomponent name="ColdboxSideBar" output="false" extends="shared.frameworks.coldbox_3_00.system.Interceptor" hint="The ColdBox Developer Side Bar">
...
<!------------------------------------------- INTERCEPTION POINTS ------------------------------------------->
	...
	<cffunction name="afterAspectsLoad" access="public" returntype="void" output="false">
		<cfargument name="event" required="true" type="shared.frameworks.coldbox_3_00.system.web.context.RequestContext">
...
<!------------------------------------------- PRIVATE METHDOS ------------------------------------------->
	...
	<cffunction name="readSideBarXML" access="private" returntype="void" output="false" hint="Read the sidebar xml configuration file">
		...
		<cfset var property = StructNew()>
 		...
 		<cftry>
			<!--- Read SideBar XML --->
			<cffile action="read" file="#ExpandPath('/shared/frameworks/coldbox_3_00/system/web/config/ColdBoxSideBar.xml')#" variable="sideBarXMLDoc">
			<!--- Parse XML --->
