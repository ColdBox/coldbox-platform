...
<Interceptor class="shared.frameworks.coldbox_3_00.system.interceptors.Deploy">
...
<cfcomponent name="DeployCommand" output="false">
	<cffunction name="init" access="public" returntype="any" hint="Constructor" output="false" >
		<cfargument name="controller" required="true" type="shared.frameworks.coldbox_3_00.system.web.Controller" hint="The coldbox controller">
...
----------------------------------------------------------------------->
<cfcomponent hint="Deployment Control Interceptor" extends="shared.frameworks.coldbox_3_00.system.Interceptor" output="false">
