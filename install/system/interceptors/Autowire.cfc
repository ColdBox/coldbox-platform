...
----------------------------------------------------------------------->
<cfcomponent hint="This is an autowire interceptor" output="false" extends="shared.frameworks.coldbox_3_00.system.Interceptor">
...
<!------------------------------------------- INTERCEPTION POINTS ------------------------------------------->
	...
	<cffunction name="afterAspectsLoad" access="public" returntype="void" output="false" >
		...
		<cfscript>
			...
			for (; x lte arrayLen(interceptorConfig.interceptors); x=x+1){
				...
				// Exclude yourself
				if( not findnocase("shared.frameworks.coldbox_3_00.system.interceptors.Autowire",interceptorConfig.interceptors[x].class) ){
	...
	<cffunction name="afterPluginCreation" access="public" returntype="void" output="false" >
		...
		<!--- ************************************************************* --->
		<cfif( NOT findnocase("shared.frameworks.coldbox_3_00.system.plugins",arguments.interceptData.pluginPath) )>
