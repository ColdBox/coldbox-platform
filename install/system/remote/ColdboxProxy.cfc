...
<cfcomponent name="ColdboxProxy" output="false" hint="This component is the coldbox remote proxy used for remote operations." >
	...
	<!--- getRemotingUtil --->
    <cffunction name="getRemotingUtil" output="false" access="private" returntype="shared.frameworks.coldbox_3_00.system.remote.RemotingUtil" hint="Get a reference to the ColdBox Remoting utility class.">
		<cfreturn createObject("component","shared.frameworks.coldbox_3_00.system.remote.RemotingUtil")>    	
    </cffunction>
	...
	<cffunction name="getCacheBox" output="false" access="private" returntype="any" hint="Get the CacheBox reference." colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.CacheFactory">
	...
	<cffunction name="getRootLogger" output="false" access="private" returntype="shared.frameworks.coldbox_3_00.system.logging.Logger" hint="Get the root logger reference.">
		<cfreturn getLogBox().getRootLogger()>
	</cffunction>
	
	<!--- Get a logger --->
	<cffunction name="getLogger" output="false" access="private" returntype="shared.frameworks.coldbox_3_00.system.logging.Logger" hint="Get a named logger reference.">
	...
	<cffunction name="getColdboxOCM" access="private" output="false" returntype="any" hint="Get ColdboxOCM: shared.frameworks.coldbox_3_00.system.cache.CacheManager or new CacheBox providers" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.IColdboxApplicationCache">
		...
		<cfif not structKeyExists(application,COLDBOX_APP_KEY) or not application[COLDBOX_APP_KEY].getColdboxInitiated() or arguments.reloadApp>
			<cflock type="exclusive" name="#appHash#" timeout="30" throwontimeout="true">
				...
				if ( not structkeyExists(application,COLDBOX_APP_KEY) OR NOT
					...
					// Load it Up baby!!
					cbController = CreateObject("component", "shared.frameworks.coldbox_3_00.system.web.Controller").init( expandPath(arguments.appMapping) );
					// Put in Scope
