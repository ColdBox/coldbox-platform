...
<!------------------------------------------- PRIVATE METHODS ------------------------------------------->
	...
	<!--- Get Context --->
	<cffunction name="getRequestContext" access="private" returntype="shared.frameworks.coldbox_3_00.system.web.context.RequestContext" hint="Retrieve the request context object" output="false" >
