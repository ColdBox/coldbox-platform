...
<cfcomponent hint="The multi-threaded cache manager." 
			 extends="shared.frameworks.coldbox_3_00.system.cache.archive.CacheManager" 
			 output="false">
...
<!------------------------------------------- PRIVATE ------------------------------------------->
	...
	<cffunction name="initPool" access="private" output="false" returntype="void" hint="Initialize and set the internal object Pool">
		<cfscript>
			instance.objectPool = CreateObject("component","shared.frameworks.coldbox_3_00.system.cache.archive.MTObjectPool").init();
		</cfscript>
	</cffunction>
