...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" output="false" returntype="CacheManager" hint="Constructor">
		...
		<cfscript>
			...
			instance.eventURLFacade = CreateObject("component","shared.frameworks.coldbox_3_00.system.cache.archive.util.EventURLFacade").init(this);
			// Cache Stats
			instance.cacheStats = CreateObject("component","shared.frameworks.coldbox_3_00.system.cache.archive.util.CacheStats").init(this);
	...
	<cffunction name="configure" access="public" output="false" returntype="void" hint="Configures the cache for operation, sets the configuration object, sets and creates the eviction policy and clears the stats. If this method is not called, the cache is useless.">
		<!--- ************************************************************* --->
		<cfargument name="cacheConfig" type="shared.frameworks.coldbox_3_00.system.cache.archive.config.CacheConfig" required="true" hint="The configuration object">
		<!--- ************************************************************* --->
		<cfscript>		
			...
			try{
				oEvictionPolicy = CreateObject("component","shared.frameworks.coldbox_3_00.system.cache.archive.policies.#getCacheConfig().getEvictionPolicy()#").init(this);
			}
			Catch(Any e){
...
<!------------------------------------------- ACCESSOR/MUTATORS ------------------------------------------->
	...
	<cffunction name="geteventURLFacade" access="public" returntype="shared.frameworks.coldbox_3_00.system.cache.archive.util.EventURLFacade" output="false" hint="Get the event url facade object.">
		<cfreturn instance.eventURLFacade>
	</cffunction>

	<!--- The cache stats --->
	<cffunction name="getCacheStats" access="public" returntype="shared.frameworks.coldbox_3_00.system.cache.archive.util.CacheStats" output="false" hint="Return the cache stats object.">
	...
	<cffunction name="setCacheConfig" access="public" returntype="void" output="false" hint="Set & Override the cache configuration bean. You can use this to programmatically alter the cache.">
		<cfargument name="CacheConfig" type="shared.frameworks.coldbox_3_00.system.cache.archive.config.CacheConfig" required="true">
		<cfset instance.CacheConfig = arguments.CacheConfig>
	</cffunction>
	<cffunction name="getCacheConfig" access="public" returntype="shared.frameworks.coldbox_3_00.system.cache.archive.config.CacheConfig" output="false" hint="Get the current cache configuration bean.">
		<cfreturn instance.CacheConfig >
	</cffunction>
	
	<!--- Get the internal object pool --->
	<cffunction name="getObjectPool" access="public" returntype="any" output="false" hint="Get the internal object pool: shared.frameworks.coldbox_3_00.system.cache.objectPool or MTobjectPool">
	...
	<cffunction name="setEvictionPolicy" access="public" returntype="void" output="false" hint="You can now override the set eviction policy by programmatically sending it in.">
		<cfargument name="evictionPolicy" type="shared.frameworks.coldbox_3_00.system.cache.archive.policies.AbstractEvictionPolicy" required="true">
...
<!------------------------------------------- PRIVATE ------------------------------------------->
	...
	<cffunction name="initPool" access="private" output="false" returntype="void" hint="Initialize and set the internal object Pool">
		<cfscript>
			instance.objectPool = CreateObject("component","shared.frameworks.coldbox_3_00.system.cache.archive.ObjectPool").init();
		</cfscript>
	</cffunction>
