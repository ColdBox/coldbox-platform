...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<cffunction name="getAssociatedCacheManager" output="false" access="public" returntype="shared.frameworks.coldbox_3_00.system.cache.archive.CacheManager" hint="Get the associated Cache Manager for this stats object">
