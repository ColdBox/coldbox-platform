...
<!------------------------------------------- PRIVATE ------------------------------------------->
	...
	<!--- The Cache Manager --->
	<cffunction name="getCacheManager" access="private" returntype="shared.frameworks.coldbox_3_00.system.cache.archive.CacheManager" output="false">
		<cfreturn instance.cacheManager>
	</cffunction>
	<cffunction name="setCacheManager" access="private" returntype="void" output="false">
		<cfargument name="cacheManager" type="shared.frameworks.coldbox_3_00.system.cache.archive.CacheManager" required="true">
