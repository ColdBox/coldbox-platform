...
<cfcomponent hint="An abstract CacheBox eviction policy" 
			 output="false" 
			 serializable="false" 
			 implements="shared.frameworks.coldbox_3_00.system.cache.policies.IEvictionPolicy"
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<cffunction name="getAssociatedCache" access="public" returntype="any" output="false" hint="Get the Associated Cache Provider of type: shared.frameworks.coldbox_3_00.system.cache.ICacheProvider" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.ICacheProvider">
