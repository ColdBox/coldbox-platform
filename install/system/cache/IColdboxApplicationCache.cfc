...
----------------------------------------------------------------------->
<cfinterface extends="shared.frameworks.coldbox_3_00.system.cache.ICacheProvider" hint="The main interface to produce a ColdBox Application cache">
	...
	<!--- getColdbox --->
    <cffunction name="getColdbox" output="false" access="public" returntype="any" hint="Get the coldbox application reference as shared.frameworks.coldbox_3_00.system.web.Controller" colddoc:generic="shared.frameworks.coldbox_3_00.system.web.Controller">
    </cffunction>

	<!--- setColdbox --->
    <cffunction name="setColdbox" output="false" access="public" returntype="void" hint="Set the coldbox application reference">
    	<cfargument name="coldbox" type="any" required="true" hint="The coldbox application reference as type: shared.frameworks.coldbox_3_00.system.web.Controller" colddoc:generic="shared.frameworks.coldbox_3_00.system.web.Controller"/>
    </cffunction>

	<!--- getEventURLFacade --->
    <cffunction name="getEventURLFacade" output="false" access="public" returntype="any" hint="Get the event caching URL facade utility" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.util.EventURLFacade">
    </cffunction>

	<!--- getItemTypes --->
	<cffunction name="getItemTypes" access="public" output="false" returntype="any" hint="Get the item types counts of the cache. These are calculated according to the prefixes set." colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.util.ItemTypeCount">
	</cffunction>
