...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" output="false" returntype="EventURLFacade" hint="Constructor">
		<cfargument name="cacheProvider" type="any" required="true" hint="The cache provider/manager this utility will be associated with as type: shared.frameworks.coldbox_3_00.system.cache.IColdboxApplicationCache" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.IColdboxApplicationCache"/>
		<cfscript>
			instance = {
