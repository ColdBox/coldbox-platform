...
----------------------------------------------------------------------->
<cfcomponent output="false" hint="This object keeps the cache statistics" implements="shared.frameworks.coldbox_3_00.system.cache.util.ICacheStats">

<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	
	<cffunction name="init" access="public" output="false" returntype="CacheStats" hint="Constructor">
		<cfargument name="cacheProvider"required="true" hint="The associated cache manager/provider of type: shared.frameworks.coldbox_3_00.system.cache.ICacheProvider" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.ICacheProvider"/>
		<cfscript>
			instance = {
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<cffunction name="getAssociatedCache" access="public" output="false" returntype="any" hint="Get the associated cache provider/manager of type: shared.frameworks.coldbox_3_00.system.cache.ICacheProvider" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.ICacheProvider">
