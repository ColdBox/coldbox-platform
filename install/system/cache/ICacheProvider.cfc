...
<cfinterface hint="The main interface for a CacheBox cache provider object, you implement it so CacheBox can manage it for you.">
	...
	<!--- getStats --->
    <cffunction name="getStats" output="false" access="public" returntype="any" hint="Get the cache statistics object as shared.frameworks.coldbox_3_00.system.cache.util.ICacheStats" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.util.ICacheStats">
    </cffunction>
	...
	<!--- getCacheFactory --->
    <cffunction name="getCacheFactory" output="false" access="public" returntype="any" hint="Get the cache factory reference this cache provider belongs to" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.CacheFactory">
    </cffunction>
    ...
    <cffunction name="setCacheFactory" output="false" access="public" returntype="void" hint="Set the cache factory reference for this cache">
    	<cfargument name="cacheFactory" type="any" required="true" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.CacheFactory"/>
    </cffunction>
