...
Or look in the /shared/frameworks/coldbox_3_00/system/cache/store/sql/*.sql for you sql script for your DB.
----------------------------------------------------------------------->
<cfcomponent hint="I am a cool cool JDBC Store for CacheBox" output="false" implements="shared.frameworks.coldbox_3_00.system.cache.store.IObjectStore">

<!------------------------------------------- CONSTRUCTOR ------------------------------------------->

	<!--- init --->
	<cffunction name="init" access="public" output="false" returntype="JDBCStore" hint="Constructor">
		<cfargument name="cacheProvider" type="any" required="true" hint="The associated cache provider as shared.frameworks.coldbox_3_00.system.cache.ICacheProvider" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.ICacheProvider"/>
		<cfscript>
			// Store Fields
			...
			instance = {
				...
				converter 		= createObject("component","shared.frameworks.coldbox_3_00.system.core.conversion.ObjectMarshaller").init()
			};
			...
			// Indexer
			instance.indexer = createObject("component","shared.frameworks.coldbox_3_00.system.cache.store.indexers.JDBCMetadataIndexer").init(fields,config,this);
