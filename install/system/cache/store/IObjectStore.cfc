...
<cfinterface hint="The main interface for CacheBox object storages.">
	...
	<!--- getIndexer --->
	<cffunction name="getIndexer" access="public" returntype="any" output="false" hint="Get the store's pool metadata indexer structure" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.store.indexers.MetadataIndexer">
	</cffunction>
