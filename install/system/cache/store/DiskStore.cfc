...
----------------------------------------------------------------------->
<cfcomponent hint="I am a disk store, I am not that fancy as I am slower." output="false" implements="shared.frameworks.coldbox_3_00.system.cache.store.IObjectStore">
	...
	<cffunction name="init" access="public" output="false" returntype="DiskStore" hint="Constructor">
		...
		<cfscript>
			...
			instance = {
				...
				indexer    		= createObject("component","shared.frameworks.coldbox_3_00.system.cache.store.indexers.MetadataIndexer").init(fields),
				converter 		= createObject("component","shared.frameworks.coldbox_3_00.system.core.conversion.ObjectMarshaller").init(),
				fileUtils		= createObject("component","shared.frameworks.coldbox_3_00.system.core.util.FileUtils")
			};
