...
<cfcomponent hint="The coolest standalone CacheBox Provider ever built" 
			 output="false" 
			 extends="shared.frameworks.coldbox_3_00.system.cache.AbstractCacheBoxProvider"
			 implements="shared.frameworks.coldbox_3_00.system.cache.ICacheProvider" 
			 serializable="false">
...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" output="false" returntype="CacheBoxProvider" hint="Constructor">
		<cfscript>
			...
			instance.elementCleaner		= CreateObject("component","shared.frameworks.coldbox_3_00.system.cache.util.ElementCleaner").init(this);
			// Utilities
			instance.utility			= createObject("component","shared.frameworks.coldbox_3_00.system.core.util.Util");
			// UUID Helper
	...
	<cffunction name="configure" access="public" output="false" returntype="void" hint="Configures the cache for operation, sets the configuration object, sets and creates the eviction policy and clears the stats. If this method is not called, the cache is useless.">
		...
		<cfscript>		
			...
			// Prepare Statistics
			instance.stats = CreateObject("component","shared.frameworks.coldbox_3_00.system.cache.util.CacheStats").init(this);
    ...
    <cffunction name="locateEvictionPolicy" output="false" access="private" returntype="any" hint="Locate the eviction policy">
    	...
    	<cfscript>
    		if( fileExists( expandPath("/shared/frameworks/coldbox_3_00/system/cache/policies/#arguments.policy#.cfc") ) ){
				return "shared.frameworks.coldbox_3_00.system.cache.policies.#arguments.policy#";
			}
    ...
    <cffunction name="locateObjectStore" output="false" access="private" returntype="any" hint="Locate the object store">
    	...
    	<cfscript>
    		if( fileExists( expandPath("/shared/frameworks/coldbox_3_00/system/cache/store/#arguments.store#.cfc") ) ){
				return "shared.frameworks.coldbox_3_00.system.cache.store.#arguments.store#";
			}
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<!--- getObjectStore --->
	<cffunction name="getObjectStore" output="false" access="public" returntype="any" hint="If the cache provider implements it, this returns the cache's object store as type: shared.frameworks.coldbox_3_00.system.cache.store.IObjectStore" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.store.IObjectStore">
