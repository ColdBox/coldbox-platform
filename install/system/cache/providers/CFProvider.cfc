...
*/
component serializable="false" implements="shared.frameworks.coldbox_3_00.system.cache.ICacheProvider"{
    ...
    */
	CFProvider function init() output=false{
		...
		instance = {
			...
			elementCleaner		= CreateObject("component","shared.frameworks.coldbox_3_00.system.cache.util.ElementCleaner").init(this),
			// Utilities
	...
	*/
	...
	/*
	* Get the cache statistics object as shared.frameworks.coldbox_3_00.system.cache.util.ICacheStats
	* @colddoc:generic shared.frameworks.coldbox_3_00.system.cache.util.ICacheStats
	*/
	any function getStats() output=false{
		return CreateObject("component", "shared.frameworks.coldbox_3_00.system.cache.providers.cf-lib.CFStats").init( getObjectStore().getStatistics() );		
	}
