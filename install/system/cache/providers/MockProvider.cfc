...
<cfcomponent hint="A mock cache provider" 
			 output="false" 
			 implements="shared.frameworks.coldbox_3_00.system.cache.IColdboxApplicationCache"
...
<!------------------------------------------- ColdBox Application Cache Methods ------------------------------------------>
	...
	<cffunction name="getItemTypes" access="public" output="false" returntype="any" hint="Get the item types counts of the cache. These are calculated according to the prefixes set.">
		<cfreturn createObject("component","shared.frameworks.coldbox_3_00.system.cache.util.ItemTypeCount")>
	</cffunction>
