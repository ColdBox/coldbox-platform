...
*/
component serializable="false" extends="shared.frameworks.coldbox_3_00.system.cache.providers.RailoProvider" implements="shared.frameworks.coldbox_3_00.system.cache.IColdboxApplicationCache"{
	...
	any function getItemTypes() output=false{
		...
		var itemTypes	= new shared.frameworks.coldbox_3_00.system.cache.util.ItemTypeCount();
