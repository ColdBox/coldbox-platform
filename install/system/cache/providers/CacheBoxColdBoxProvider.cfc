...
----------------------------------------------------------------------->
<cfcomponent output="false" extends="shared.frameworks.coldbox_3_00.system.cache.providers.CacheBoxProvider" implements="shared.frameworks.coldbox_3_00.system.cache.IColdboxApplicationCache">
	...
	<cffunction name="init" access="public" output="false" returntype="any" hint="Constructor">
		<cfscript>
			...
			// URL Facade Utility
			instance.eventURLFacade		= CreateObject("component","shared.frameworks.coldbox_3_00.system.cache.util.EventURLFacade").init(this);
...
<!------------------------------------------- ColdBox Application Related Operations ------------------------------------------>
    ...
    <cffunction name="setColdbox" output="false" access="public" returntype="void" hint="Set the coldbox application reference">
    	<cfargument name="coldbox" type="any" required="true" hint="The coldbox application reference as shared.frameworks.coldbox_3_00.system.web.Controller" colddoc:generic="shared.frameworks.coldbox_3_00.system.web.Controller"/>
	...
	<cffunction name="getItemTypes" access="public" output="false" returntype="any" hint="Get the item types counts of the cache. These are calculated according to the prefixes set.">
		...
		var itemTypes	= createObject("component","shared.frameworks.coldbox_3_00.system.cache.util.ItemTypeCount");
