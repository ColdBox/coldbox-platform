...
<!----------------------------------------- CONSTRUCTOR ------------------------------------->			
	...
	<cffunction name="init" access="public" returntype="ReportHandler" hint="Constructor" output="false" >
		<cfargument name="cacheBox" 	 	type="shared.frameworks.coldbox_3_00.system.cache.CacheFactory" required="true" hint="The cache factory binded to"/>
		...
		<cfscript>
			...
			variables.skinPath  = "/shared/frameworks/coldbox_3_00/system/cache/report/skins/#arguments.skin#";
