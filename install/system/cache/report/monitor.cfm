...
<cfset reportHandler = createObject("component","shared.frameworks.coldbox_3_00.system.cache.report.ReportHandler").init(attributes.cacheFactory,
																								   attributes.baseURL,
																								   attributes.skin,
																								   attributes,
																								   caller)>
...
<style type="text/css"><cfinclude template="/shared/frameworks/coldbox_3_00/system/cache/report/skins/#attributes.skin#/cachebox.css"></style>
<script type="text/javascript"><cfinclude template="/shared/frameworks/coldbox_3_00/system/cache/report/skins/#attributes.skin#/cachebox.js"></script>
</cfsavecontent>
