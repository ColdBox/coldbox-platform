	...
	*/
	function configure(){
		...
		cacheBox = {
			...
			logBoxConfig = "shared.frameworks.coldbox_3_00.system.cache.config.LogBoxConfig", 
			...
			caches = {
				sampleCache1 = {
					provider="shared.frameworks.coldbox_3_00.system.cache.providers.CacheBoxProvider",
					properties = {
