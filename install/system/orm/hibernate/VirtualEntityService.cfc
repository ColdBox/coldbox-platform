...
UserService=CreateObject("component", "shared.frameworks.coldbox_3_00.system.orm.hibernate.VirtualEntityService").init("User");

You can also use this virtual service as a template object and extend and override as needed.

import shared.frameworks.coldbox_3_00.system.orm.hibernate.*;
...
----------------------------------------------------------------------->
*/
component extends="shared.frameworks.coldbox_3_00.system.orm.hibernate.BaseORMService" accessors="true"{
