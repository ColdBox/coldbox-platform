...
<cfcomponent name="TransferLoader"
			 ...
			 output="false"
			 extends="shared.frameworks.coldbox_3_00.system.Interceptor">
...
<!---------------------------------------- PUBLIC --------------------------------------------------->
	...
	<cffunction name="afterConfigurationLoad" output="false" access="public" returntype="void" hint="Load Transfer after configuration has loaded">
		<!--- *********************************************************************** --->
		<cfargument name="event" 			required="true" type="any" hint="The event object: shared.frameworks.coldbox_3_00.system.web.context.RequestContext">
		...
		<cfscript>
			...
			var configFactory = createObject("component","shared.frameworks.coldbox_3_00.system.orm.transfer.TransferConfigFactory").init();
			...
			if( getProperty("LoadBeanInjector") ){
				...
				/* Create TDO */
				TDO = CreateObject("component","shared.frameworks.coldbox_3_00.system.orm.transfer.TDOBeanInjectorObserver").init(argumentCollection=TDOArgs);
			}
