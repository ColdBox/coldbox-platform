...
<cfcomponent hint="I am the ColdBox BeanFactory plugin that takes care of autowiring and dependency injection"
			 extends="shared.frameworks.coldbox_3_00.system.Plugin"
			 output="false"
			 singleton="true">
...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" returntype="BeanFactoryCompat" output="false" hint="constructor">
		<!--- ************************************************************* --->
		<cfargument name="controller" type="any" required="true" hint="shared.frameworks.coldbox_3_00.system.web.Controller">
		<!--- ************************************************************* --->
		<cfscript>
			...
			setDICacheDictionary(CreateObject("component","shared.frameworks.coldbox_3_00.system.core.collections.BaseDictionary").init('DIMetadata'));
			instance.autowireCache = structnew();
			// Bean Populator
			instance.beanPopulator 	= createObject("component","shared.frameworks.coldbox_3_00.system.core.dynamic.BeanPopulator").init();
			// Mixer util
			instance.mixerUtil     	= CreateObject("component","shared.frameworks.coldbox_3_00.system.core.dynamic.MixerUtil").init();
			// Cache Reference
			...
			<cflock type="exclusive" name="plugins.autowire.#targetCacheKey#" timeout="30" throwontimeout="true">
				<cfscript>
					if ( not instance.DICacheDictionary.keyExists(targetCacheKey) ){
						...
						if ( mdEntry.autowire and findNoCase("shared.frameworks.coldbox_3_00.system",metaData.name) EQ 0 ){
...
<!------------------------------------------- PRIVATE ------------------------------------------->
	...
	<cffunction name="stopClassRecursion" access="private" returntype="any" hint="Should we stop recursion or not due to class name found: Boolean" output="false" colddoc:generic="Boolean">
		...
		<!--- ************************************************************* --->
		<cfscript>
			var coldboxReservedClasses = "shared.frameworks.coldbox_3_00.system.Plugin,shared.frameworks.coldbox_3_00.system.EventHandler,shared.frameworks.coldbox_3_00.system.Interceptor";
			var x = 1;
	...
	<cffunction name="getDICacheDictionary" access="private" output="false" returntype="any" hint="Get DICacheDictionary" colddoc:generic="shared.frameworks.coldbox_3_00.system.core.collections.BaseDictionary">
	...
	<cffunction name="setDICacheDictionary" access="private" output="false" returntype="void" hint="Set DICacheDictionary">
		<cfargument name="DICacheDictionary" type="any" required="true" colddoc:generic="shared.frameworks.coldbox_3_00.system.core.collections.BaseDictionary"/>
