...
<!---------------------------------------- CONSTRUCTOR --------------------------------------------------->
	...
	<cfset variables.extrasRSS2 = createObject('component','shared.frameworks.coldbox_3_00.system.web.feeds.RSS2Generator').init()>
	<cfset variables.extrasShared = createObject('component','shared.frameworks.coldbox_3_00.system.web.feeds.SharedGenerator').init()>
