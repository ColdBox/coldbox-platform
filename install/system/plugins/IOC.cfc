    ...
    <cffunction name="buildAdapter" output="false" access="private" returntype="any" hint="Build an IoC framework adapter and return it">
		...
		<cfscript>	
			...
			switch( arguments.framework ){
				case "coldspring" 	: { adapterPath = "shared.frameworks.coldbox_3_00.system.ioc.adapters.ColdSpringAdapter"; break; }
				case "coldspring2" 	: { adapterPath = "shared.frameworks.coldbox_3_00.system.ioc.adapters.ColdSpring2Adapter"; break; }
				case "lightwire" 	: { adapterPath = "shared.frameworks.coldbox_3_00.system.ioc.adapters.LightWireAdapter"; break; }
				case "wirebox" 		: { adapterPath = "shared.frameworks.coldbox_3_00.system.ioc.adapters.WireBoxAdapter"; break; }
