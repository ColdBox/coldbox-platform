...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" returntype="Layout" hint="Constructor" output="false">
		<cfargument name="appender" type="any" required="true" default="" hint="The appender linked to (shared.frameworks.coldbox_3_00.system.logging.AbstractAppender)" colddoc:generic="shared.frameworks.coldbox_3_00.system.logging.AbstractAppender"/>
		<cfscript>
...
<!------------------------------------------- PUBLIC ------------------------------------------>
	...
	<cffunction name="format" output="false" access="public" returntype="string" hint="Format a logging event message into your own format">
		<cfargument name="logEvent" type="any"   required="true"   hint="The logging event to use to create a message (shared.frameworks.coldbox_3_00.system.logging.LogEvent)" colddoc:generic="shared.frameworks.coldbox_3_00.system.logging.LogEvent">
