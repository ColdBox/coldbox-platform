...
----------------------------------------------------------------------->
<cfcomponent extends="shared.frameworks.coldbox_3_00.system.logging.AbstractAppender" 
			 output="false"
	...
	<cffunction name="init" access="public" returntype="ScopeAppender" hint="Constructor" output="false" >
		...
		<cfscript>
			...
			// Scope storage
			instance.scopeStorage = createObject("component","shared.frameworks.coldbox_3_00.system.core.collections.ScopeStorage").init();
			// Scope Checks
