...
Date        :	3/13/2009
Description :
	A AsyncRollingFileAppender. This appenders rotates the log files according
	to the properties defined asynchronously.
...
----------------------------------------------------------------------->
<cfcomponent extends="shared.frameworks.coldbox_3_00.system.logging.appenders.AsyncFileAppender" 
			 output="false"
...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" returntype="AsyncRollingFileAppender" hint="Constructor" output="false">
		...
		<cfscript>
			...
			instance.fileRotator = createObject("component","shared.frameworks.coldbox_3_00.system.logging.util.FileRotator").init();
