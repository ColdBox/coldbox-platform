...
<cfcomponent output="false" hint="Resembles a logging event within logBox.">
	...
	<cfscript>
		...
		instance.extraInfo	= "";
		// converters
		instance.xmlConverter = createObject("component","shared.frameworks.coldbox_3_00.system.core.conversion.XMLConverter").init();
		instance.jsonConverter = createObject("component","shared.frameworks.coldbox_3_00.system.core.conversion.JSON").init();
	</cfscript>
