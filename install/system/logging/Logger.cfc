...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="getRootLogger" access="public" returntype="any" output="false" hint="Get the root logger" colddoc:generic="shared.frameworks.coldbox_3_00.system.logging.Logger">
	...
	<cffunction name="setRootLogger" access="public" returntype="void" output="false" hint="Set the root logger for this named logger.">
		<cfargument name="RootLogger" required="true" colddoc:generic="shared.frameworks.coldbox_3_00.system.logging.Logger">
...
<!------------------------------------------- APPENDER METHODS ------------------------------------------->
	...
	<cffunction name="addAppender" output="false" access="public" returntype="void" hint="Add a new appender to the list of appenders for this logger. If the appender already exists, then it will not be added.">
		<cfargument name="newAppender" required="true" default="" hint="The new appender to add to this logger programmatically." colddoc:generic="shared.frameworks.coldbox_3_00.system.logging.AbstractAppender"/>
		<cfscript>
			var name= "";
	...
	<cffunction name="logMessage" output="false" access="public" returntype="void" hint="Write an entry into the loggers registered with this LogBox instance.">
		...
		<cfscript>
			...
			if( canLog(arguments.severity) ){
				...
				logEvent = createobject("component","shared.frameworks.coldbox_3_00.system.logging.LogEvent").init(argumentCollection=arguments);		
