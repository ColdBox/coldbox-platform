...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------>
    ...
    <cffunction name="init" output="false" access="public" returntype="BeanPopulator" hint="Constructor">
    	<cfscript>
    		JSONUtil  = createObject("component","shared.frameworks.coldbox_3_00.system.core.conversion.JSON").init();
			mixerUtil = createObject("component","shared.frameworks.coldbox_3_00.system.core.dynamic.MixerUtil").init();
