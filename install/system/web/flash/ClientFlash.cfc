...
----------------------------------------------------------------------->
<cfcomponent output="false" extends="shared.frameworks.coldbox_3_00.system.web.flash.AbstractFlashScope" hint="A ColdBox client flash scope">
...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------>
    ...
    <cffunction name="init" output="false" access="public" returntype="ClientFlash" hint="Constructor">
    	...
    	<cfscript>
			...
			// Marshaller
			instance.converter = createObject("component","shared.frameworks.coldbox_3_00.system.core.conversion.ObjectMarshaller").init();
