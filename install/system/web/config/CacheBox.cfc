	...
	*/
	function configure(){
		...
		cacheBox = {
			...
			// logBoxConfig = "shared.frameworks.coldbox_3_00.system.web.config.LogBox", 
			...
			caches = {
				...
				template = {
					provider = "shared.frameworks.coldbox_3_00.system.cache.providers.CacheBoxColdBoxProvider",
					properties = {
