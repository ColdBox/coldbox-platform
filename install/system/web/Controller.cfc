...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" returntype="shared.frameworks.coldbox_3_00.system.web.Controller" access="public" hint="Constructor" output="false">
		<cfargument name="appRootPath" type="any" required="true" hint="The app Root Path"/>
		<cfscript>
			// CFML Engine Utility
			instance.CFMLEngine = CreateObject("component","shared.frameworks.coldbox_3_00.system.core.cf.CFMLEngine").init();
			...
			createObject("component","shared.frameworks.coldbox_3_00.system.web.loader.FrameworkLoader").init().loadSettings(this);

			// Setup the ColdBox Services
			services.LoaderService 		= CreateObject("component", "shared.frameworks.coldbox_3_00.system.web.services.LoaderService").init(this);
			services.RequestService 	= CreateObject("component","shared.frameworks.coldbox_3_00.system.web.services.RequestService").init(this);
			services.DebuggerService 	= CreateObject("component","shared.frameworks.coldbox_3_00.system.web.services.DebuggerService").init(this);
			services.HandlerService 	= CreateObject("component", "shared.frameworks.coldbox_3_00.system.web.services.HandlerService").init(this);
			services.PluginService 		= CreateObject("component","shared.frameworks.coldbox_3_00.system.web.services.PluginService").init(this);
			
			// Nasty cf7, once you die this goes out. Modules are cf8 only and above.
			if ( instance.CFMLEngine.isMT() ){
				services.ModuleService = CreateObject("component", "shared.frameworks.coldbox_3_00.system.web.services.ModuleService").init(this);
			}
			services.InterceptorService = CreateObject("component", "shared.frameworks.coldbox_3_00.system.web.services.InterceptorService").init(this);
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<cffunction name="getCFMLEngine" access="public" returntype="any" output="false" hint="Get the CFMLEngine utility(shared.frameworks.coldbox_3_00.system.core.cf.CFMLEngine)" coldoc:generic="shared.frameworks.coldbox_3_00.system.core.cf.CFMLEngine">
		<cfreturn instance.CFMLEngine>
	</cffunction>
	
	<!--- getSetCacheBox --->
	<cffunction name="getCacheBox" access="public" returntype="any" output="false" hint="Get the application's CacheBox instance as shared.frameworks.coldbox_3_00.system.cache.CacheFactory" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.CacheFactory">
    ...
    <cffunction name="setCacheBox" access="public" returntype="void" output="false" hint="Set the application's CacheBox instance">
    	<cfargument name="cacheBox" required="true" hint="As shared.frameworks.coldbox_3_00.system.cache.CacheFactory" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.CacheFactory">
    	<cfset instance.cacheBox = arguments.cacheBox>
    </cffunction>
    
	<!--- getLogBox --->
	<cffunction name="getLogBox" output="false" access="public" returntype="any" hint="Get the application's LogBox instance" colddoc:generic="shared.frameworks.coldbox_3_00.system.logging.LogBox">
	...
	<cffunction name="setLogBox" output="false" access="public" returntype="void" hint="Set the logBox instance">
		<cfargument name="logBox" required="true" hint="The logBox instance" colddoc:generic="shared.frameworks.coldbox_3_00.system.logging.LogBox"/>
		<cfset instance.logBox = arguments.logBox>
	</cffunction>

	<!--- getwireBox --->
	<cffunction name="getWireBox" output="false" access="public" returntype="any" hint="Get the application's LogBox instance" colddoc:generic="shared.frameworks.coldbox_3_00.system.logging.LogBox">
	...
	<cffunction name="setWireBox" output="false" access="public" returntype="void" hint="Set the WireBox instance">
		<cfargument name="wireBox" required="true" hint="The WireBox instance" colddoc:generic="shared.frameworks.coldbox_3_00.system.ioc.Injector"/>
	...
	<cffunction name="getColdboxOCM" access="public" output="false" returntype="any" hint="Get ColdboxOCM: shared.frameworks.coldbox_3_00.system.cache.CacheManager or new CacheBox providers shared.frameworks.coldbox_3_00.system.cache.IColdboxApplicationCache" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.IColdboxApplicationCache">
	...
	<cffunction name="setColdboxOCM" access="public" output="false" returntype="void" hint="Set ColdboxOCM">
		<cfargument name="coldboxOCM" type="any" required="true" hint="shared.frameworks.coldbox_3_00.system.cache.CacheManager"/>
		<cfset instance.coldboxOCM = arguments.coldboxOCM/>
	</cffunction>

	<!--- Loader Service --->
	<cffunction name="getLoaderService" access="public" output="false" returntype="any" hint="Get LoaderService: shared.frameworks.coldbox_3_00.system.web.services.LoaderService">
	...
	<!--- Module Service --->
	<cffunction name="getModuleService" access="public" returntype="any" output="false" hint="Get ModuleService: shared.frameworks.coldbox_3_00.system.web.services.ModuleService">
	...
	<!--- Exception Service --->
	<cffunction name="getExceptionService" access="public" output="false" returntype="any" hint="Get ExceptionService: shared.frameworks.coldbox_3_00.system.web.services.ExceptionService">
		<cfreturn CreateObject("component", "shared.frameworks.coldbox_3_00.system.web.services.ExceptionService").init(this)/>
	</cffunction>

	<!--- Request Service --->
	<cffunction name="getRequestService" access="public" output="false" returntype="any" hint="Get RequestService: shared.frameworks.coldbox_3_00.system.web.services.RequestService">
	...
	<!--- Debugger Service --->
	<cffunction name="getDebuggerService" access="public" output="false" returntype="any" hint="Get DebuggerService: shared.frameworks.coldbox_3_00.system.web.services.DebuggerService">
	...
	<!--- Plugin Service --->
	<cffunction name="getPluginService" access="public" output="false" returntype="any" hint="Get PluginService: shared.frameworks.coldbox_3_00.system.web.services.PluginService">
	...
	<!--- Interceptor Service --->
	<cffunction name="getInterceptorService" access="public" output="false" returntype="any" hint="Get interceptorService: shared.frameworks.coldbox_3_00.system.web.services.InterceptorService">
	...
	<!--- Handler Service --->
	<cffunction name="getHandlerService" access="public" output="false" returntype="any" hint="Get HandlerService: shared.frameworks.coldbox_3_00.system.web.services.HandlerService">
...
<!------------------------------------------- PRIVATE ------------------------------------------->
	...
	<!--- Get the util object --->
	<cffunction name="getUtil" access="private" output="false" returntype="any" hint="Create and return a util object" colddoc:generic="shared.frameworks.coldbox_3_00.system.core.util.Util">
    ...
    <cffunction name="sendRelocation" output="false" access="private" returntype="void" hint="Send a CF relocation via ColdBox">
		...
		<cfelse>
			<cfinclude template="/shared/frameworks/coldbox_3_00/system/includes/cf7_cflocation_compat.cfm">
		</cfif>
    </cffunction>
