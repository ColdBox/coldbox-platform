...
----------------------------------------------------------------------->
<cfcomponent hint="Loads a coldbox xml configuration file" output="false" extends="shared.frameworks.coldbox_3_00.system.web.loader.AbstractApplicationLoader">
...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------>
	...
	<cffunction name="init" output="false" access="public" returntype="any" hint="constructor">
		...
		<cfscript>
			...
			// Regex for JSON
			instance.jsonRegex = "^(\{|\[)(.)*(\}|\])$";
			instance.jsonUtil = createObject("component","shared.frameworks.coldbox_3_00.system.core.conversion.JSON").init();
...
<!------------------------------------------- PUBLIC ------------------------------------------>
	...
	<cffunction name="parseCacheSettings" output="false" access="public" returntype="void" hint="Parse Cache Settings">
		...
		<cfscript>
			...
			// else, load the default coldbox cachebox config
				...
				configStruct.cacheBox.configFile = "shared.frameworks.coldbox_3_00.system.web.config.CacheBox";
			}
		</cfscript>
	</cffunction>	
	...
	<!--- getJSONUtil --->
	<cffunction name="getJSONUtil" access="public" output="false" returntype="shared.frameworks.coldbox_3_00.system.core.conversion.JSON" hint="Create and return a util object for JSON">
