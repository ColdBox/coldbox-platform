...
----------------------------------------------------------------------->
<cfcomponent hint="This is the base request context decorator used as an abstract class for implementing request context decorators" output="false" extends="shared.frameworks.coldbox_3_00.system.web.context.RequestContext">

<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
		
	<cffunction name="init" access="public" output="false" hint="constructor" returntype="RequestContextDecorator">
		<!--- ************************************************************* --->
		<cfargument name="oContext" 	type="any" 	required="true" hint="The original context we are decorating. shared.frameworks.coldbox_3_00.system.web.context.RequestContext">
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<cffunction name="getRequestContext" access="public" output="false" returntype="any" hint="Get the original request context. shared.frameworks.coldbox_3_00.system.web.context.RequestContext">
...
<!------------------------------------------- PRIVATE ------------------------------------------->
	...
	<!--- Get Set Controller --->
	<cffunction name="getController" access="private" output="false" returntype="any" hint="Get controller: shared.frameworks.coldbox_3_00.system.web.Controller">
