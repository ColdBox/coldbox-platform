...
----------------------------------------------------------------------->
<cfcomponent output="false" hint="The coldbox interceptor service" extends="shared.frameworks.coldbox_3_00.system.web.services.BaseService">
...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" output="false" returntype="InterceptorService" hint="Constructor">
		...
		<cfscript>
			...
			instance.requestBuffer = CreateObject("component","shared.frameworks.coldbox_3_00.system.core.util.RequestBuffer").init();
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<cffunction name="getRequestBuffer" access="public" returntype="any" output="false" hint="Get a coldbox request buffer: shared.frameworks.coldbox_3_00.system.core.util.RequestBuffer">
	...
	<cffunction name="parseMetadata" returntype="struct" access="private" output="false" hint="I get a components valid interception points">
		...
		<cfscript>
			...
			if ( structKeyExists(arguments.metadata, "extends") and 
				 (arguments.metadata.extends.name neq "shared.frameworks.coldbox_3_00.system.Interceptor" and
				  arguments.metadata.extends.name neq "shared.frameworks.coldbox_3_00.system.Plugin" and
				  arguments.metadata.extends.name neq "shared.frameworks.coldbox_3_00.system.EventHandler" )
			){
				// Recursive lookup
	...
	<cffunction name="registerInterceptionPoint" access="private" returntype="void" hint="Register an Interception point into a new or created interception state." output="false" >
		...
		<cfscript>
			...
			if ( not structKeyExists(getInterceptionStates(), arguments.state) ){
				oInterceptorState = CreateObject("component","shared.frameworks.coldbox_3_00.system.web.context.InterceptorState").init(arguments.state);
