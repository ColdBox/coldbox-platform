...
01/18/2007 - Created
----------------------------------------------------------------------->
<cfcomponent name="RequestService" output="false" hint="This service takes care of preparing and creating request contexts. Facades to FORM and URL" extends="shared.frameworks.coldbox_3_00.system.web.services.BaseService">
...
<!------------------------------------------- INTERNAL COLDBOX EVENTS ------------------------------------------->
	...
	<cffunction name="onConfigurationLoad" access="public" output="false" returntype="void">
		<cfscript>
			...
			switch(flashType){
				case "session" : {
					flashpath = "shared.frameworks.coldbox_3_00.system.web.flash.SessionFlash";
					break;
				}
				case "client" : {
					flashpath = "shared.frameworks.coldbox_3_00.system.web.flash.ClientFlash";
					break;
				}
				case "cluster" : {
					flashpath = "shared.frameworks.coldbox_3_00.system.web.flash.ClusterFlash";
					break;
				}
				case "cache" : {
					flashpath = "shared.frameworks.coldbox_3_00.system.web.flash.ColdboxCacheFlash";
					break;
				}
				case "mock" : {
					flashpath = "shared.frameworks.coldbox_3_00.system.web.flash.MockFlash";
					break;
				}
			}
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<!--- Request Capture --->
	<cffunction name="requestCapture" access="public" returntype="any" output="false" hint="I capture an incoming request. Returns: shared.frameworks.coldbox_3_00.system.web.context.RequestContext" colddoc:generic="shared.frameworks.coldbox_3_00.system.web.context.RequestContext">
		<cfscript>
	...
	<cffunction name="eventCachingTest" access="public" output="false" returntype="void" hint="Tests if the incoming context is an event cache">
		<cfargument name="context" 	required="true"  type="any" hint="The request context to test for event caching." colddoc:generic="shared.frameworks.coldbox_3_00.system.web.context.RequestContext">
		<cfscript>
			var eventCacheKey   = "";
	...
	<!--- getFlashScope --->
    <cffunction name="getFlashScope" output="false" access="public" returntype="any" hint="Get the current running Flash Ram Scope of base type:shared.frameworks.coldbox_3_00.system.web.flash.AbstractFlashScope">
...
<!------------------------------------------- PRIVATE ------------------------------------------->
	...
	<cffunction name="createContext" access="private" output="false" returntype="any" hint="Creates a new request context object">
		...
		oContext = CreateObject("component","shared.frameworks.coldbox_3_00.system.web.context.RequestContext").init(controller.getConfigSettings());
