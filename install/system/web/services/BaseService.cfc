...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cfscript>
		...
		variables.util 			= CreateObject("component","shared.frameworks.coldbox_3_00.system.core.util.Util");
	</cfscript>
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<!--- Get OCM Facade --->	
	<cffunction name="getColdboxOCM" access="public" output="false" returntype="any" hint="Get ColdboxOCM: shared.frameworks.coldbox_3_00.system.cache.CacheManager or new CacheBox providers">
