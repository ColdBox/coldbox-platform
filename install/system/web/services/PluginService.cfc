...
01/18/2007 - Created
----------------------------------------------------------------------->
<cfcomponent name="PluginService" output="false" hint="The coldbox plugin service" extends="shared.frameworks.coldbox_3_00.system.web.services.BaseService">
...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" output="false" returntype="PluginService" hint="Constructor">
		...
		<cfscript>
			...
			instance.CORE_PLUGINS_PATH = "shared.frameworks.coldbox_3_00.system.plugins";
			// Core Extensions Location
			instance.CORE_EXTENSIONS_PATH = "shared.frameworks.coldbox_3_00.system.extensions.plugins";
			...
			setCacheDictionary(CreateObject("component","shared.frameworks.coldbox_3_00.system.core.collections.BaseDictionary").init('PluginMetadata'));
