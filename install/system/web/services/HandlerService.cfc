...
----------------------------------------------------------------------->
<cfcomponent extends="shared.frameworks.coldbox_3_00.system.web.services.BaseService" hint="This is the main Coldbox Handler service" output="false">
...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" output="false" returntype="HandlerService" hint="Constructor">
		...
		<cfscript>
			...
			setHandlerCacheDictionary(CreateObject("component","shared.frameworks.coldbox_3_00.system.core.collections.BaseDictionary").init('Handlersmetadata'));
			// Setup the Event Cache Dictionary
			setEventCacheDictionary(CreateObject("component","shared.frameworks.coldbox_3_00.system.core.collections.BaseDictionary").init('EventCache'));
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<cffunction name="getHandler" output="false" access="public" returntype="any" hint="Returns a valid event handler object ready for execution">
		<!--- ************************************************************* --->
		<cfargument name="ehBean" 			type="any" required="true" hint="The event handler bean to use: shared.frameworks.coldbox_3_00.system.web.context.EventHandlerBean"/>
	...
	<cffunction name="getRegisteredHandler" access="public" hint="I parse the incoming event string into an event handler bean that is used for executions." returntype="shared.frameworks.coldbox_3_00.system.web.context.EventHandlerBean"  output="false">
		<!--- ************************************************************* --->
		...
		var handlersList 			= instance.registeredHandlers;
		var handlersExternalList 	= instance.registeredExternalHandlers;
		var HandlerBean 			= CreateObject("component","shared.frameworks.coldbox_3_00.system.web.context.EventHandlerBean").init(instance.handlersInvocationPath);
		var moduleReceived			= "";
	...
	<cffunction name="invalidEvent" output="false" access="private" returntype="void" hint="Invalid Event procedures. Throws EventHandlerNotRegisteredException">
		...
		<cfargument name="ehBean" type="any" 	required="true" hint="The event handler bean" colddoc:generic="shared.frameworks.coldbox_3_00.system.web.context.EventHandlerBean"/>
		<cfscript>
			var iData			= structnew();
...
<!------------------------------------------- ACCESSOR/MUTATORS ------------------------------------------->
	...
	<cffunction name="getHandlerCacheDictionary" access="public" returntype="shared.frameworks.coldbox_3_00.system.core.collections.BaseDictionary" output="false">
	...
	<cffunction name="setHandlerCacheDictionary" access="public" returntype="void" output="false">
		<cfargument name="HandlerCacheDictionary" type="shared.frameworks.coldbox_3_00.system.core.collections.BaseDictionary" required="true">
		<cfset instance.HandlerCacheDictionary = arguments.HandlerCacheDictionary>
	</cffunction>

	<!--- Event Cache Dictionary --->
	<cffunction name="getEventCacheDictionary" access="public" returntype="shared.frameworks.coldbox_3_00.system.core.collections.BaseDictionary" output="false">
		<cfreturn instance.EventCacheDictionary>
	</cffunction>
	<cffunction name="setEventCacheDictionary" access="public" returntype="void" output="false">
		<cfargument name="EventCacheDictionary" type="shared.frameworks.coldbox_3_00.system.core.collections.BaseDictionary" required="true">
