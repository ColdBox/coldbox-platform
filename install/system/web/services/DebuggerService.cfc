...
----------------------------------------------------------------------->
<cfcomponent output="false" hint="This is the service that powers the ColdBox Debugger." extends="shared.frameworks.coldbox_3_00.system.web.services.BaseService">
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<cffunction name="renderDebugLog" access="public" hint="Return the debug log." output="false" returntype="Any">
		...
		<!--- Render debuglog --->
		<cfsavecontent variable="renderedDebugging"><cfinclude template="/shared/frameworks/coldbox_3_00/system/includes/Debug.cfm"></cfsavecontent>
	...
	<cffunction name="renderCachePanel" access="public" hint="Renders the caching panel." output="false" returntype="any">
		...
		<!--- Generate Debugging --->
		<cfsavecontent variable="content"><cfinclude template="/shared/frameworks/coldbox_3_00/system/includes/panels/CachePanel.cfm"></cfsavecontent>
    ...
    <cffunction name="renderCacheReport" output="false" access="public" returntype="any" hint="Render a cache report for a specific cache">
		...
		<!--- Generate Debugging --->
		<cfsavecontent variable="content"><cfinclude template="/shared/frameworks/coldbox_3_00/system/includes/panels/CacheReport.cfm"></cfsavecontent>
    ...
    <cffunction name="renderCacheContentReport" output="false" access="public" returntype="any" hint="Render a cache's content report">
		...
		<!--- Render content out --->
		<cfsavecontent variable="content"><cfinclude template="/shared/frameworks/coldbox_3_00/system/includes/panels/CacheContentReport.cfm"></cfsavecontent>
	...
	<!--- Configuration Bean --->
	<cffunction name="getDebuggerConfig" access="public" output="false" returntype="any" hint="Get DebuggerConfig: shared.frameworks.coldbox_3_00.system.web.config.DebuggerConfig">
	...
	<cffunction name="setDebuggerConfig" access="public" output="false" returntype="void" hint="Set DebuggerConfig">
		<cfargument name="DebuggerConfig" type="shared.frameworks.coldbox_3_00.system.web.config.DebuggerConfig" required="true"/>
