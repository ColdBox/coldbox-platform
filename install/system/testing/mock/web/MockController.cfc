...
----------------------------------------------------------------------->
<cfcomponent hint="This is the ColdBox Unit Test Front Controller." output="false" extends="shared.frameworks.coldbox_3_00.system.web.Controller">
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<cffunction name="init" returntype="shared.frameworks.coldbox_3_00.system.web.Controller" access="public" hint="Constructor" output="false">
		...
		<cfscript>
			...
			// Override mocks
			setRequestService( CreateObject("component","shared.frameworks.coldbox_3_00.system.testing.mock.services.MockRequestService").init(this) );
