...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------>
	...
	<cffunction name="init" access="public" output="false" returntype="MockBox" hint="Create an instance of MockBox">
		...
		<cfscript>
			var tempDir =  "/shared/frameworks/coldbox_3_00/system/testing/stubs";
			...
			instance.mockGenerator 	= createObject("component","shared.frameworks.coldbox_3_00.system.testing.mockutils.MockGenerator").init(this);
...
<!------------------------------------------- PUBLIC ------------------------------------------>
	...
	<!--- Get Generator --->
	<cffunction name="getMockGenerator" access="public" returntype="shared.frameworks.coldbox_3_00.system.testing.mockutils.MockGenerator" output="false" hint="Get the Mock Generator Utility">
...
<!------------------------------------------- MOCK CREATION METHODS ------------------------------------------>
	...
	<cffunction name="createStub" output="false" access="public" returntype="any" hint="Create an empty stub object that you can use for mocking.">
		<cfargument name="callLogging" 	type="boolean" required="false" default="true" hint="Add method call logging for all mocked methods"/>
		<cfscript>
			return createMock(className="shared.frameworks.coldbox_3_00.system.testing.mockutils.Stub",callLogging=arguments.callLogging);
		</cfscript>
	</cffunction>	
