...
---------------------------------------------------------------------->
<cfcomponent output="false" extends="shared.frameworks.coldbox_3_00.system.testing.BaseTestCase" hint="A base test for unit testing event handlers">
    ...
    <cffunction name="setup" output="false" access="public" returntype="void" hint="Prepare for testing">
    	<cfscript>
			...
			// Create Mock Objects
			variables.mockController 	 = mockBox.createEmptyMock("shared.frameworks.coldbox_3_00.system.testing.mock.web.MockController");
			variables.mockRequestContext = getMockRequestContext();
			variables.mockRequestService = mockBox.createEmptyMock("shared.frameworks.coldbox_3_00.system.web.services.RequestService").$("getContext", variables.mockRequestContext);
			variables.mockLogBox	 	 = mockBox.createEmptyMock("shared.frameworks.coldbox_3_00.system.logging.LogBox");
			variables.mockLogger	 	 = mockBox.createEmptyMock("shared.frameworks.coldbox_3_00.system.logging.Logger");
			variables.mockFlash		 	 = mockBox.createMock("shared.frameworks.coldbox_3_00.system.web.flash.MockFlash").init(mockController);
			variables.mockCacheBox   	 = mockBox.createEmptyMock("shared.frameworks.coldbox_3_00.system.cache.CacheFactory");
			variables.mockWireBox		 = mockBox.createEmptyMock("shared.frameworks.coldbox_3_00.system.ioc.Injector");
