...
---------------------------------------------------------------------->
<cfcomponent extends="shared.frameworks.mxunit.framework.TestCase" 
			 output="false" 
	...
	<cfscript>
		...
		// Prepare MockBox
		instance.mockBox = createObject("component","shared.frameworks.coldbox_3_00.system.testing.MockBox").init();
	</cfscript>
	...
	<cffunction name="setup" hint="The main setup method for running ColdBox enabled tests" output="false">
		...
		if( this.loadColdbox ){
			...
			if( structKeyExists(application,getColdboxAppKey()) ){
				...
				instance.controller = CreateObject("component", "shared.frameworks.coldbox_3_00.system.testing.mock.web.MockController").init( appRootPath );
...
<!------------------------------------------- HELPERS ------------------------------------------->
	...
	<!--- getMockBox --->
	<cffunction name="getMockBox" output="false" access="private" returntype="shared.frameworks.coldbox_3_00.system.testing.MockBox" hint="Get a reference to the MockBox framework">
		<cfreturn instance.mockBox>
	</cffunction>
	
	<!--- Get a Mock Datasource Object --->
	<cffunction name="getMockDatasource" access="private" output="false" returnType="shared.frameworks.coldbox_3_00.system.core.db.DatasourceBean" hint="I will return to you a datasourceBean according to the mocking parameters sent">
		...
		<cfscript>
			...
			return getMockBox().createMock("shared.frameworks.coldbox_3_00.system.core.db.DatasourceBean").init(arguments);
		</cfscript>
	</cffunction>
	
	<!--- getMockConfigBean --->
	<cffunction name="getMockConfigBean" access="private" output="false" returnType="shared.frameworks.coldbox_3_00.system.core.collections.ConfigBean" hint="I will return to you a configBean according to the mocking configuration structure you send in">
		<cfargument name="configStruct" type="struct" required="false" default="#structnew()#" hint="A memento of name-value pairs to init">
	    <cfscript>
			return getMockBox().createMock("shared.frameworks.coldbox_3_00.system.core.collections.ConfigBean").init(arguments.configStruct);
		</cfscript>
	</cffunction>
		
	<!--- getMockRequestContext --->
	<cffunction name="getMockRequestContext" output="false" access="private" returntype="shared.frameworks.coldbox_3_00.system.web.context.RequestContext" hint="Builds an empty functioning request context mocked with methods via MockBox.  You can also optionally wipe all methods on it.">
		...
		<cfscript>
			...
			if( arguments.clearMethods ){
				...
				return getMockBox().createEmptyMock("shared.frameworks.coldbox_3_00.system.web.context.RequestContext");
			}
			
			// Create functioning request context
			mockRC = getMockBox().createMock("shared.frameworks.coldbox_3_00.system.web.context.RequestContext");
			...
			if( structKeyExists(arguments,"decorator") ){
				mockController = CreateObject("component", "shared.frameworks.coldbox_3_00.system.testing.mock.web.MockController").init('/unittest');
    ...
    <cffunction name="getMockPlugin" output="false" access="private" returntype="any" hint="Get a plugin mocked with capabilities">
    	...
    	<cfscript>
    		...
    		// Create Mock Objects
			var mockController 		= mockBox.createEmptyMock("shared.frameworks.coldbox_3_00.system.testing.mock.web.MockController");
			var mockRequestService 	= mockBox.createEmptyMock("shared.frameworks.coldbox_3_00.system.web.services.RequestService");
			var mockLogBox	 		= mockBox.createEmptyMock("shared.frameworks.coldbox_3_00.system.logging.LogBox");
			var mockLogger	 		= mockBox.createEmptyMock("shared.frameworks.coldbox_3_00.system.logging.Logger");
			var mockFlash		 	= mockBox.createMock("shared.frameworks.coldbox_3_00.system.web.flash.MockFlash").init(mockController);
			var mockCacheBox   		= mockBox.createEmptyMock("shared.frameworks.coldbox_3_00.system.cache.CacheFactory");
			var mockWireBox   		= mockBox.createEmptyMock("shared.frameworks.coldbox_3_00.system.ioc.Injector");
	...
	<!--- getColdboxOCM --->
    <cffunction name="getColdboxOCM" access="private" output="false" returntype="any" hint="Get ColdboxOCM: shared.frameworks.coldbox_3_00.system.cache.CacheManager or new CacheBox providers shared.frameworks.coldbox_3_00.system.cache.IColdboxApplicationCache" colddoc:generic="shared.frameworks.coldbox_3_00.system.cache.IColdboxApplicationCache">
	...
	<!--- getFlashScope --->
	<cffunction name="getFlashScope" output="false" access="private" returntype="shared.frameworks.coldbox_3_00.system.web.Flash.AbstractFlashScope" hint="Returns to you the currently used flash ram object">
