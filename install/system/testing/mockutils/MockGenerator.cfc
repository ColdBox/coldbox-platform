...
<cfcomponent output="false" hint="The guy in charge of creating mocks">
	...
	<cffunction name="init" access="public" output="false" returntype="MockGenerator" hint="Constructor">
		<cfargument name="mockBox" type="shared.frameworks.coldbox_3_00.system.testing.MockBox" required="true"/>
		<cfscript>
...
<!------------------------------------------- PRIVATE ------------------------------------------>
	...
	<!--- Get Mock Box --->
	<cffunction name="getmockBox" access="private" returntype="shared.frameworks.coldbox_3_00.system.testing.MockBox" output="false">
