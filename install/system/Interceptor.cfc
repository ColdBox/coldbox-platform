...
<cfcomponent hint="This is the base Interceptor class"
			 output="false"
			 extends="shared.frameworks.coldbox_3_00.system.FrameworkSupertype"
			 serializable="false">
...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" returntype="any" output="false">
		<cfargument name="controller" type="any" 	required="true"  hint="The ColdBox controller reference: shared.frameworks.coldbox_3_00.system.web.Controller">
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<cffunction name="getInterceptorService" access="public" returntype="shared.frameworks.coldbox_3_00.system.web.services.interceptorService" output="false">
...
<!------------------------------------------- BUFFER METHODS ------------------------------------------>
	...
	<!--- getBufferObject --->
	<cffunction name="getBufferObject" output="false" access="public" returntype="any" hint="Get the request buffer object: shared.frameworks.coldbox_3_00.system.core.util.RequestBuffer">
