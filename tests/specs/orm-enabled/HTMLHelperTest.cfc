component extends="coldbox.system.testing.BaseModelTest" model="coldbox.system.modules.HTMLHelper.models.HTMLHelper" {
    ...
    function testMeta(){
        var data = [ { name: "luis", content: "awesome" }, { name: "test", content: "2", type: "equiv" } ];
    ...
    function testTableArrayofStructs(){
        data = [ { id: 1, name: "luis" }, { id: 2, name: "peter" } ];
    ...
    function testSlugify(){
        data = { title1: "My Awesome Post", title2: "Sept. Is great- for me--and you" };
