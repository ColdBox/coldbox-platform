...
<cfscript>
	function setup(){
		...
		loge.init(message="I am logging an information message from LogBox to my twitter status.",severity=twitter.logLevels.INFO,extraInfo=structnew(),category="coldbox.tests.logging");
	}
