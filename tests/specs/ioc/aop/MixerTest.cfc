component extends="coldbox.system.testing.BaseTestCase"{
	...
	function setup(){
		...
		// mixer
		mixer = createMock( "coldbox.system.aop.Mixer" )
			.configure( mockInjector, {} );
	}
	...
	function testdecorateAOPTarget(){
		...
		mockMapping = createMock( "coldbox.system.ioc.config.Mapping" )
			.$( "getName","unitTest" );
	...
	function testprocessTargetMethods(){
		...
		dictionary = [
			{classes="", methods=createEmptyMock( "coldbox.system.aop.Matcher" ).$( "matchMethod",true), aspects=[ "Transaction" ]}
		];
		...
		this.$wbAOPTargets = {};
		dictionary = [
			{classes="", methods=createEmptyMock( "coldbox.system.aop.Matcher" ).$( "matchMethod",false), aspects="Transaction" }
		];
		mixer.$( "weaveAdvice" );
		mixer.processTargetMethods(this, mockMapping, md, dictionary);
		assertTrue( mixer.$never( "weaveAdvice" ) );
