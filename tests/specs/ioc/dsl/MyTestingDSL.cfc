...
<cfcomponent implements="coldbox.system.ioc.dsl.IDSLBuilder" output="false">
	...
	<!--- init --->
    <cffunction name="init" access="public" returntype="any" hint="Configure the DSL for operation and returns itself" colddoc:generic="coldbox.system.ioc.dsl.IDSLBuilder">
	...
	<!--- process --->
    <cffunction name="process" access="public" returntype="any" hint="Process an incoming DSL definition and produce an object with it.">
