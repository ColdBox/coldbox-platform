<cfcomponent extends="coldbox.system.testing.BaseTestCase">
    ...
    function testRegisterListeners(){
        ...
        // Mocking
        listeners = [
            { class: "coldbox.tests.specs.ioc.config.listeners.MyListener", name: "myDude", properties: {} },
            { class: "coldbox.tests.specs.ioc.config.listeners.MyListener", name: "lui", properties: {} }
        ];
        ...
        // exception
        listeners = [ { class: "coldbox.tests.specs.ioc.config.listeners.MyLister", name: "myDude", properties: {} } ];
        prepareMock( binder ).$( "getListeners", listeners );
        try{
            injector.registerListeners();
    ...
    function testConfigureCacheBox(){
        ...
        config = { enabled: true, configFile: "", classNamespace: "coldbox.system.cache" };
