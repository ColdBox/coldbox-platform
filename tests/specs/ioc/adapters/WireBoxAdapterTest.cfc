...
<cfscript>
	...
	function creationTest(){
		adapter.init(definitionFile="coldbox.tests.specs.ioc.adapters.resources.WireBox");
		...
		parent.init(definitionFile="coldbox.tests.specs.ioc.adapters.resources.WireBox");
