component extends="coldbox.system.ioc.config.Binder"{
	...
	*/
	function configure(){
		...
		var modelsPath = "coldbox.test-harness.models";
		...
		map( "categoryDAO" ).to( "#modelsPath#.ioc.category.CategoryDAO" )
		...
		map( "ApplicationCategoryBean" ).to( "#modelsPath#.ioc.category.CategoryBean" ).into( this.SCOPES.APPLICATION );
		...
		map( "abstractService" ).to( "#modelsPath#.parent.AbstractService" )
