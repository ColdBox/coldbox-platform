...
<cfcomponent output="false" extends="coldbox.system.ioc.config.Binder">
    ...
    function configure(){
        ...
        wireBox = {
            ...
            cacheBox: {
                enabled: true // configFile = "coldbox.system.ioc.config.CacheBox", An optional configuration file to use for loading CacheBox // cacheFactory = ""  A reference to an already instantiated CacheBox CacheFactory // classNamespace = "" A class path namespace to use to create CacheBox: Default=coldbox.system.cache or wirebox.system.cache
            },
        ...
        wirebox.mappings = {
            ...
            buffer: {
                ...
                DIConstructorArgs: [ { name: "buffer", value: "16", javaCast: "int" } ]
            }
        };
    }
    </cfscript>
