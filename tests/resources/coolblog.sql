...
# Database: coolblog
# Generation Time: 2013-06-14 18:43:09 +0000
# ************************************************************
...
VALUES
	(1,'http://blog.coldbox.org/feeds/rss.cfm','http://blog.coldbox.org/','','ColdBox Platform','The official ColdBox Blog','2011-04-08 15:19:13','2011-04-08 15:19:13',00000001,NULL,NULL,NULL);
...
VALUES
	...
	('A13C0DB0-0CBC-4D85-A5261F2E3FCBEF91','Training','Training','2013-06-14 11:40:56',NULL),
	('A13C0DB0-0CBC-4D85-A5261F2E3FCBEF92','general','A test general','2010-03-31 13:06:03',NULL),
...
INSERT INTO `logs` (`id`, `severity`, `category`, `logdate`, `appendername`, `message`, `extrainfo`)
VALUES
...
VALUES
	('4028818e2fb6c893012fe637c5db00a7','George','Form Injector','george','george',NULL,2,00000001),
	('402884cc310b1ae901311be89381000a','ken','Advanced Guru','kenneth','smith','2013-02-21 00:00:00',2,00000001),
	('4A386F4D-DCF4-6587-7B89B3BD57C97155','Joe','Fernando','joe','joe','2009-05-15 00:00:00',1,00000001),
	('88B73A03-FEFA-935D-AD8036E1B7954B76','Luis','Majano','lui','lmajano','2009-04-08 00:00:00',1,00000001),
	('8a64b3712e3a0a5e012e3a110fab0003','Vladymir','Ugryumov','vlad','vlad','2011-02-18 00:00:00',1,00000001),
	('99fc94fd3b98c834013b98c928120001','Juerg','Anderegg','juerg','juerg','2012-12-14 00:00:00',NULL,00000001),
	('99fc94fd3ba7f266013bad49e3c50003','Tanja','Zogg','tanja','tanja','2012-12-18 00:00:00',NULL,00000001);
