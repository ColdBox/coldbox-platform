...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" output="false" returntype="interceptorService" hint="Constructor">
		...
		<cfscript>
			...
			setInterceptionPoints('afterConfigurationLoad,afterAspectsLoad,preProcess,preEvent,postEvent,preRender,postRender,postProcess,afterCacheElementInsert,afterCacheElementRemoved');
			/* Init Container */
