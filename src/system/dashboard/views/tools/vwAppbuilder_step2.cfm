...
<div id="applicationloggin_set"  style="display: none">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5" class="tablelisting">
	 ...
	 <tr onMouseOver="getHint('coldboxlogging')" onMouseOut="resetHint()">
     	...
     	<td>
     	<input type="text" name="coldboxlogslocation" id="coldboxlogslocation" value="logs" size="40"> <a href="JavaScript:openBrowser('#getValue("xehFileBrowser")#','coldboxlogslocation')" title="Select from web root"><img id="coldboxlogslocation_img" src="images/icons/folder.png" border="0" align="absmiddle"></a>
     	</td>
     </tr>
