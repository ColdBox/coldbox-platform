 ...
 <!--- ************************************************************* --->
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5" class="tablelisting">
	  ...
	  <tr bgcolor="##ffffff" onMouseOver="getHint('appdevmapping')" onMouseOut="resetHint()">
     	...
     	<td>
     	<input type="text" name="appdevmapping" id="appdevmapping" value="" size="40"> <a href="javascript:openBrowser('#Context.getValue("xehFileBrowser")#','appdevmapping')" title="Select from web root"><img id="appdevmapping_img" src="images/icons/folder.png" border="0" align="absmiddle"></a>
     	</td>
     </tr>
