...
<div class="headerbar">
	...
	<div style="float:right;clear:both;margin-right:10px">
		<!--- HOME --->
		<div id="topbuttons" >
			<a href="?event=#Context.getValue("xehHome")#" target="mainframe" onmouseover="rollover('btn_home')" onmouseout="rollout('btn_home')"><img  src="images/icons/home.gif" border="0" id="btn_home" srcoff="images/icons/home.gif" srcon="images/icons/home_on.gif"><br>
			Home</a>
		</div>
		<!--- SETTINGS --->
		<div id="topbuttons" >
			<a href="?event=#Context.getValue("xehSettings")#" target="mainframe" onmouseover="rollover('btn_settings')" onmouseout="rollout('btn_settings')"><img  src="images/icons/settings.gif" border="0" id="btn_settings" srcoff="images/icons/settings.gif" srcon="images/icons/settings_on.gif"><br>
			Settings</a>
		</div>
		<!--- TOOLS --->
		<div id="topbuttons" >
			<a href="?event=#Context.getValue("xehTools")#" target="mainframe" onmouseover="rollover('btn_tools')" onmouseout="rollout('btn_tools')"><img  src="images/icons/tools.gif" border="0" id="btn_tools" srcoff="images/icons/tools.gif" srcon="images/icons/tools_on.gif"><br>
			Tools</a>
		</div>
		<!--- BD/CFADMIN --->
		...
		<!--- UPDATE --->
		<div id="topbuttons">
			<a href="?event=#Context.getValue("xehUpdate")#" target="mainframe" onmouseover="rollover('btn_update')" onmouseout="rollout('btn_update')"><img  src="images/icons/update.gif" border="0" id="btn_update" srcoff="images/icons/update.gif" srcon="images/icons/update_on.gif"><br>
			Update</a>
		</div>
		<!--- BUG REPORTS --->
		<div id="topbuttons">
			<a href="?event=#Context.getValue("xehBugs")#" target="mainframe" onmouseover="rollover('btn_bugs')" onmouseout="rollout('btn_bugs')"><img  src="images/icons/bugreports.gif" border="0" id="btn_bugs" srcoff="images/icons/bugreports.gif" srcon="images/icons/bugreports_on.gif"><br>
			Submit Bug</a>
		</div>
	</div>
