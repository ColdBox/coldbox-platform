<cfoutput>
<cfset qURLS = Context.getValue("qURLS")>
<!--- HELPBOX --->
...
<div class="maincontentbox">
	...
	<form id="updateform" name="updateform" method="post" action="javascript:doFormEvent('#Context.getValue("xehCheck")#','content',document.updateform)" onSubmit="document.updateform.button_check.disabled=true">
	  <div align="center">
