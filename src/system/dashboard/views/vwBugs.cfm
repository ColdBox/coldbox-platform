...
<!--- Sub Menu Links --->
<ul>
	<li><a href="javascript:doEvent('#Context.getValue("xehSubmitBug")#', 'content', {})" onMouseOver="getHint('submitbug')" onMouseOut="resetHint()">Submit Bugs</a></li>
...
doEvent('#Context.getValue("xehSubmitBug")#', 'content', {});
</script>
</cfoutput>