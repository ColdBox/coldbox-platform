...
<cfcomponent name="ehUpdater" extends="coldbox.system.eventhandler">
	...
	<cffunction name="docheckForUpdates" access="public" returntype="void">
		...
		<!--- Param Site--->
		<cfset paramValue("distribution_site", "")>
		<cftry>
			<!--- Check for URL --->
			<cfif getValue("distribution_site") eq "">
			...
			<!--- Get a WS Object --->
			<cfset updateWS = CreateObject("webservice",getValue("distribution_site"))>
			<!--- Check for Updates --->
	...
	<cffunction name="dspUpdaterResults" access="public" returntype="void">
		...
		<!--- Set the View --->
		<cfset setView("update/vwUpdaterResults")>
	</cffunction>
