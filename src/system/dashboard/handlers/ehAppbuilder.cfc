...
<cfcomponent name="ehAppbuilder" extends="coldbox.system.eventhandler">
	...
	<cffunction name="dspAppBuilder" access="public" returntype="void">
		...
		<!--- Set the View --->
		<cfset Context.setView("tools/vwAppBuilder")>
	</cffunction>
	...
	<cffunction name="generateApplication" access="public" returntype="void">
		...
		<cfset Context.paramValue("onapplicationstart_cb", "false")>
		<cfset Context.paramValue("onrequeststart_cb", "false")>
		<cfset Context.paramValue("onrequestend_cb", "false")>
		<cfset Context.paramValue("onexception_cb", "false")>
