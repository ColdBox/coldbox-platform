...
&lt;beans&gt;
	&lt;bean id="<xsl:value-of select="//bean/@name"/>DAO" class="<xsl:value-of select="//bean/@path"/>DAO"&gt;
	...
	&lt;bean id="<xsl:value-of select="//bean/@name"/>Service" class="<xsl:value-of select="//bean/@path"/>Service"&gt;
		&lt;constructor-arg name="<xsl:value-of select="//bean/@name"/>DAO"&gt;
			&lt;ref bean="<xsl:value-of select="//bean/@name"/>DAO"/&gt;
		&lt;/constructor-arg&gt;
