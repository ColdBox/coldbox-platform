...
<environmentcontrol>
	...
	<environment name="staging" urls="staging.coldboxses.com">
		<!--ColdBoxSpecific Settings -->
		<Setting name="BaseURL"	value="http://staging.coldboxses.com/" />
		<!-- custom settigns  -->
	</environment>
	
	<environment name="live" urls="www.coldboxses.com">
		<!--ColdBoxSpecific Settings -->
		<Setting name="BaseURL"	value="http://www.coldboxses.com/" />
		<!-- custom settigns  -->
	</environment>
