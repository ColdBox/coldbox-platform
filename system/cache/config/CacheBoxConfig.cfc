...
component accessors="true" {
     ...
     */
    function cache( required name, string provider = variables.DEFAULTS.cacheBoxProvider, struct properties = {} ){
        variables.caches[ arguments.name ] = { provider: arguments.provider, properties: arguments.properties };
        return this;
    }
