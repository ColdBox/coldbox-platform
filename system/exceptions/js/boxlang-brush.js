...
;(function()
{
  ...
  function Brush()
  {
    ...
    this.regexList = [
      ...
      // Special keywords
      { regex: new RegExp('\\bthis\\b', 'gmi'),                        css: 'color6' },       // this keyword
      { regex: new RegExp('\\bsuper\\b', 'gmi'),                       css: 'color6' },       // super keyword

      // Annotations
      { regex: new RegExp('@\\w+', 'g'),                               css: 'color5' },       // annotations like @foo
