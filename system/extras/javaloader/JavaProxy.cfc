...
<cffunction name="_findMethod" hint="finds the method that closest matches the signature" access="public" returntype="any" output="false">
	...
	<cfscript>
		...
		throwit("JavaProxy.MethodNotFoundException", "Could not find the designated method", "Could not find the method '#arguments.methodName#' in the class #_getClass().getName()#");
	</cfscript>
</cffunction>
...
<cffunction name="throwit" access="private" hint="Throws an Exception" output="false">
