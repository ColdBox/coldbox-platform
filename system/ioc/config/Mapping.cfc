...
<cfcomponent hint="I model a WireBox object mapping in all of its glory and splendour" output="false">
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Get the instance memento structure"
        doc_generic="struct"
    >
        <cfreturn instance>
    </cffunction>
    ...
    <!--- Virtual Inheritance --->
    <cffunction
        name="getVirtualInheritance"
        access="public"
        returntype="any"
        output="false"
        hint="Get the virtual inheritance mapping"
    >
        <cfreturn instance.virtualInheritance>
    </cffunction>
    <cffunction
        name="setVirtualInheritance"
        access="public"
        returntype="any"
        output="false"
        hint="Set the virtual inheritance mapping"
    >
    ...
    <cffunction
        ...
        returntype="boolean"
        output="false"
        hint="Checks if the mapping needs virtual inheritace or not"
    >
    ...
    <cffunction
        ...
        returntype="any"
        output="false"
        hint="Get the thread safety for wiring bit"
        coldstruct:generic="boolean"
    >
    ...
    <cffunction
        ...
        returntype="any"
        output="false"
        hint="Set the thread safety for wiring bit"
    >
    ...
    <cffunction
        name="getInfluenceClosure"
        access="public"
        returntype="any"
        output="false"
        hint="Get the influence closure. Empty string if not exists"
    >
        <cfreturn instance.influenceClosure>
    </cffunction>
    <cffunction
        name="setInfluenceClosure"
        access="public"
        returntype="any"
        output="false"
        hint="Set the influence closure."
    >
    ...
    <cffunction
        ...
        returntype="any"
        output="false"
        hint="Get the mapping's extra attributes"
    >
        <cfreturn instance.extraAttributes>
    </cffunction>
    <cffunction
        name="setExtraAttributes"
        access="public"
        returntype="any"
        output="false"
        hint="Set the mapping's extra attributes"
    >
    ...
    <cffunction
        ...
        returntype="any"
        output="false"
        hint="Get the mapping aliases array"
        doc_generic="Array"
    >
    ...
    <cffunction
        ...
        returntype="any"
        output="false"
        hint="Get the method that this mapping needs to execute from a mapping factory"
    >
    ...
    <cffunction
        ...
        returntype="any"
        output="false"
        hint="Set the method used for getting this mapping from a factory"
    >
    ...
    <cffunction
        ...
        returntype="any"
        output="false"
        hint="Get the name of the constructor method"
    >
    ...
    <cffunction
        ...
        returntype="any"
        output="false"
        hint="Override the name of the constructor method"
    >
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Flag describing if you are using autowire or not as Boolean"
        doc_generic="Boolean"
    >
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Flag describing if this mapping is an AOP aspect or not"
        doc_generic="Boolean"
    >
    ...
    <!--- isAspectAutoBinding --->
    <cffunction
        name="isAspectAutoBinding"
        output="false"
        access="public"
        returntype="any"
        hint="Is this mapping an auto aspect binding"
        doc_generic="Boolean"
    >
    ...
    <cffunction
        name="setAspectAutoBinding"
        output="false"
        access="public"
        returntype="any"
        hint="Set the aspect auto binding bit"
    >
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Using auto init of mapping target or not as boolean"
        doc_generic="Boolean"
    >
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Does this mapping have a DSL construction element or not as Boolean"
        doc_generic="boolean"
    >
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Set the cache properties for this mapping (Needs cachebox integration)"
    >
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Get this mappings cache properties structure"
        doc_generic="struct"
    >
    ...
    <cffunction
        name="getDIConstructorArguments"
        output="false"
        access="public"
        returntype="any"
        hint="Get all the constructor argument definitions array"
        doc_generic="array"
    >
    ...
    <cffunction
        name="addDIConstructorArgument"
        output="false"
        access="public"
        returntype="any"
        hint="Add a new constructor argument to this mapping"
    >
        <cfargument
            name="name"
            required="false"
            hint="The name of the constructor argument (Not used for: JAVA,WEBSERVICE)"
        />
        ...
        for( x = 1; x lte arrayLen( instance.DIConstructorArgs ); x++ ){
            if(
                structKeyExists( arguments, "name" ) AND structKeyExists( instance.DIConstructorArgs[ x ], "name" ) AND
                instance.DIConstructorArgs[ x ].name eq arguments.name
            ){
                return this;
            }
        }
    ...
    <!--- addDIMethodArgument --->
    <cffunction
        name="addDIMethodArgument"
        output="false"
        access="public"
        returntype="any"
        hint="Add a new method argument to this mapping"
    >
        ...
        for( x = 1; x lte arrayLen( instance.DIMethodArgs ); x++ ){
            if(
                structKeyExists( instance.DIMethodArgs[ x ], "name" ) AND
                instance.DIMethodArgs[ x ].name eq arguments.name
            ){
                return this;
            }
        }
    ...
    <cffunction
        name="getDIMethodArguments"
        output="false"
        access="public"
        returntype="any"
        hint="Get all the method argument definitions array"
        doc_generic="array"
    >
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Get all the DI property definitions array"
        doc_generic="Array"
    >
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Add a new cfproperty definition"
    >
        ...
        for( x = 1; x lte arrayLen( instance.DIProperties ); x++ ){
            if( instance.DIProperties[ x ].name eq arguments.name ){
                return this;
            }
        }
        structAppend( def, arguments, true );
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Get all the DI setter definitions array"
        doc_generic="array"
    >
    ...
    <cffunction name="addDISetter" output="false" access="public" returntype="any" hint="Add a new DI setter definition">
        ...
        for( x = 1; x lte arrayLen( instance.DISetters ); x++ ){
            if( instance.DISetters[ x ].name eq arguments.name ){
                return this;
            }
        }
    ...
    <!--- onDIComplete --->
    <cffunction
        name="getOnDIComplete"
        output="false"
        access="public"
        returntype="any"
        hint="Get all the DI complete methods array"
        doc_generic="array"
    >
        <cfreturn instance.onDIComplete>
    </cffunction>
    <cffunction
        name="setOnDIComplete"
        output="false"
        access="public"
        returntype="any"
        hint="Set the DI Complete method array"
    >
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Checks if this mapping has already been processed or not"
        doc_generic="Boolean"
    >
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Flag this mapping as discovered"
    >
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Get the internal mapping metadata of the object"
    >
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Set the mappings CFC target metadata"
    >
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Is this mapping eager initialized or not as Boolean"
        doc_generic="Boolean"
    >
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Get the discovered provider methods array"
        doc_generic="Array"
    >
    ...
    <!--- addProviderMethod --->
    <cffunction
        name="addProviderMethod"
        output="false"
        access="public"
        returntype="any"
        hint="Add a new provider method to this mapping"
    >
    ...
    <cffunction
        ...
        access="public"
        returntype="any"
        hint="Process a mapping for metadata discovery and more"
    >
        ...
        <cfargument
            name="metadata"
            required="false"
            hint="The metadata of an a-la-carte processing, use instead of retrieveing again"
        />
        <!--- Link the metadata --->
            ...
            if( NOT instance.discovered ){
                ...
                if( structKeyExists( arguments, "metadata" ) ){
                    ...
                    if( len( binder.getMetadataCache() ) ){
                        ...
                        md = injector
                            .getCacheBox()
                            .getCache( binder.getMetadataCache() )
                ...
                if( NOT len( instance.scope ) ){
                    ...
                    if( structKeyExists( md, "singleton" ) ){
                        instance.scope = arguments.binder.SCOPES.SINGLETON;
                    }
                    // Registered Scope Processing
                    if( structKeyExists( md, "scope" ) ){
                        instance.scope = md.scope;
                    }
    ...
    <!--- processAOPBinding --->
    <cffunction
        name="processAOPBinding"
        output="false"
        access="private"
        returntype="any"
        hint="Process the AOP self binding aspects"
    >
        <cfargument name="binder" required="true" hint="The binder requesting the processing"/>
    ...
    <!--- processDIMetadata --->
    <cffunction
        name="processDIMetadata"
        returntype="void"
        access="private"
        output="false"
        hint="Process methods/properties for dependency injection"
    >
        <cfargument name="binder" required="true" hint="The binder requesting the processing"/>
        <cfargument name="metadata" required="true" hint="The metadata to process"/>
    ...
    <!--- getDIDefinition --->
    <cffunction
        name="getDIDefinition"
        output="false"
        access="private"
        returntype="any"
        hint="Get a new DI definition structure"
        doc_generic="structure"
    >
