...
component accessors="true" serializable="false" extends="coldbox.system.FrameworkSupertype" {
    ...
    function setExplicitView( required view, module = "", struct args = {} ){
        variables.explicitView = { "view": arguments.view, "module": arguments.module, "args": arguments.args };
        return this;
    }
    ...
    function renderLayout(
        ...
        if( !structKeyExists( arguments, "layout" ) ){
            ...
            if( len( cbox_implicitLayout ) > 4 && right( cbox_implicitLayout, 4 ) == ".cfm" ){
     ...
     */
    function locateModuleLayout( required layout, module = "", boolean explicitModule = false ){
     ...
     * @explicitModule Are we locating explicitly or implicitly for a module layout
     */
    function locateModuleView( required view, module = "", boolean explicitModule = false ){
