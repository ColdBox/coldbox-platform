...
component accessors="true" extends="coldbox.system.FrameworkSupertype" threadsafe {
    ...
    function rc( required name, required value, boolean overwrite = true ){
        ...
        variables.thisRoute.rc.insert( arguments.name, arguments.value, arguments.overwrite );
        return this;
    }
    ...
    function prc( required name, required value, boolean overwrite = true ){
        ...
        variables.thisRoute.prc.insert( arguments.name, arguments.value, arguments.overwrite );
        return this;
    }
    ...
    function toRedirect( required target, statusCode = 301 ){
        ...
        // Construct arguments
        variables.thisRoute.append( { redirect: arguments.target, statusCode: arguments.statusCode }, true );
        // register the route
        addRoute( argumentCollection = variables.thisRoute );
        // reinit
        variables.thisRoute = initRouteDefinition();
    ...
    function toResponse( required body, numeric statusCode = 200, statusText = "Ok" ){
        ...
        // Construct arguments
        variables.thisRoute.append(
            { response: arguments.body, statusCode: arguments.statusCode, statusText: arguments.statusText },
            true
        );
        // register the route
        addRoute( argumentCollection = variables.thisRoute );
