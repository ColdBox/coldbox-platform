...
component serializable="false" accessors="true" {
    ...
    private function _runEvent(
        ...
        var iData = { "processedEvent": arguments.event, "eventArguments": arguments.eventArguments };
        ...
        try{
            ...
            if( NOT arguments.prePostExempt ){
                ...
                if( oHandler._actionExists( "post#results.ehBean.getMethod()#" ) ){
                    invoker( target = oHandler, method = "post#results.ehBean.getMethod()#", argCollection = args );
                }
