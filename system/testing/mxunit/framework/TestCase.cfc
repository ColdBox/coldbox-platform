...
/*********************************** ASSERTION METHODS ***********************************/
	...
	*/
	function assertArrayEquals( required array expected, required array actual, message="" ){
		variables.assert.equals( arguments.expected, arguments.actual, arguments.message );
	}
	...
	*/
	function assertEquals( required any expected, required any actual, message="" ){
		variables.assert.equal( arguments.expected, arguments.actual, arguments.message );
	}
	...
	*/
	function assertEqualsCase( required any expected, required any actual, message="" ){
		variables.assert.equalWithCase( arguments.expected, arguments.actual, arguments.message );
	}
	...
	*/
	function assertFalse( required string condition, message="" ){
		assert.isFalse( arguments.condition, arguments.message );
	}
	...
	*/
	function assertNotEquals( required any expected, required any actual, message="" ){
		variables.assert.notEqual( arguments.expected, arguments.actual, arguments.message );
	}
	...
	*/
	function assertNotSame( required expected, required actual, message="" ){
		variables.assert.notSame( arguments.expected, arguments.actual, arguments.message );
	}
	...
	*/
	function assertSame( required expected, required actual, message="" ){
		variables.assert.same( arguments.expected, arguments.actual, arguments.message );
	}
