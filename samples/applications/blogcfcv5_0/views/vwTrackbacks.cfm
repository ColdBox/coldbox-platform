...
<cfset article = requestContext.getValue("article")>
...
<form action="#cgi.script_name#?id=#requestContext.getValue("id")#" method="post" enctype="application/x-www-form-urlencoded" id="tbForm">
	<input type="hidden" name="event" value="#requestContext.getValue("xehAddTrackback")#">
	<fieldset class="sideBySide">
	<label for="blogName">Your Blog Name:</label>
	<input type="text" id="blogName" name="blog_name" value="#requestContext.getValue("blog_name","")#" maxlength="255" />
	</fieldset>
	<fieldset class="sideBySide">
	<label for="title">Your Blog Entry Title:</label>
	<input type="text" id="title" name="title" value="#requestContext.getValue("title","")#" maxlength="255" />
	</fieldset>
	<fieldset>
	<label for="excerpt">Excerpt from your Blog:</label><br/>
	<textarea id="excerpt" name="excerpt" cols=50 rows=10>#requestContext.getValue("excerpt","")#</textarea>
	</fieldset>
	<fieldset class="sideBySide">
	<label for="url">Your Blog Entry URL:</label>
	<input type="text" id="url" name="url" value="#requestContext.getValue("url","")#" maxlength="255" />
	</fieldset>
