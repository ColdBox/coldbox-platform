...
<cfmodule template="../../tags/podlayout.cfm" title="#getResource("archivesbysubject")#">
	...
	<cfloop query="cats">
		<cfoutput><a href="#application.blog.makeCategoryLink(categoryid)#">#categoryName# (#entryCount#)</a> [<a href="#application.rootURL#/index.cfm?event=#getValue("xehRSS")#&mode=full&mode2=cat&catid=#categoryid#">RSS</a>]<br></cfoutput>
	</cfloop>
