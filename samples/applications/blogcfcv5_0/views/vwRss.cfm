...
<cftry>
	<cfcontent type="text/xml"><cfoutput>#application.blog.generateRSS(mode=getvalue("mode"),params=getvalue("params"),version=getvalue("version"),additionalTitle=getvalue("additionalTitle"))#</cfoutput>
	<cfcatch>
