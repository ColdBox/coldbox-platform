...
<cfset comments = Context.getValue("comments")>
	...
	<cfmodule template="../tags/datatable.cfm" data="#comments#" editlink="?event=#Context.getValue("xehComment")#" label="Comments"
			  linkcol="comment" defaultsort="posted" defaultdir="desc" showAdd="false"
			  deleteEvent="#Context.getValue("xehDeleteComment")#">
