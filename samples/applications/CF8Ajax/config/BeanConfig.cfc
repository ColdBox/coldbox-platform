<cfcomponent name="LightBaseBeanConfig" extends="coldbox.system.extras.lightwire.BaseConfigObject" hint="A LightWire configuration bean.">
<!--- 
...
--->
	...
	<cffunction name="init" output="false" returntype="any" hint="I initialize the config bean.">
		<cfscript>
			...
			//parseXMLConfigFile("beandefs.xml.cfm");
