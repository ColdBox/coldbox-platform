...
<table width="100%" cellspacing=0 cellpadding=5 class="adminEditTable">
	...
	<tr valign="top">
		...
		<td>
			...
			<option value="#id#" <cfif getValue("conferenceidfk","") is id>selected</cfif>>#name#</option>
			</cfloop>
			</select>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<option value="1" <cfif getValue("readonly")>selected</cfif>>Yes</option>
		<option value="0" <cfif not getValue("readonly")>selected</cfif>>No</option>
		</select></td>
	</tr>
	<tr valign="top">
		<td align="right"><b>Active:</b></td>
		<td><select name="active">
		<option value="1" <cfif getValue("active")>selected</cfif>>Yes</option>
		<option value="0" <cfif not getValue("active")>selected</cfif>>No</option>
		</select></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
