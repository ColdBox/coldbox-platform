...
<table border="1" cellspacing="0" cellpadding="1" bgcolor="##eaeaea" align="center" style="border-bottom:2px solid ##ddd;border-right:2px solid ##ddd; border-left:1px solid ##eaeaea; border-top: 1px solid ##eaeaea;background: ##f5f5f5">
	<tr valign="top" bgcolor="##dddddd">
		...
		<cfloop index="i" from="1" to="#arrayLen(rc.locales)#">
			<option value="#rc.locales[i].toString()#" <cfif application.i18nUtils.getfwLocale() eq rc.locales[i].toString()>selected</cfif>>#rc.locales[i].toString()#</option>
		</cfloop>
		</select>
		</td>
	...
	<td colspan="10" bgcolor="##b6e7ff">#application.i18nUtils.isBIDI()#</td>
	</tr>
	<tr valign="top">
	...
	<td colspan="10" bgcolor="##b6e7ff">#application.i18nUtils.i18nDateTimeFormat(rc.now,rc.dateF,rc.timeF,rc.thisTZ)#</td>
	</tr>
	<tr valign="top">
	<td align="right" valign="top"><b>i18nDateFormat:</b></td>
	<td colspan="10" bgcolor="##b6e7ff">#application.i18nUtils.i18nDateFormat(rc.now,rc..dateF,rc.thisTZ)#</td>
	</tr>
	<tr valign="top">
	<td align="right" valign="top"><b>i18nTimeFormat:</b></td>
	<td colspan="10" bgcolor="##b6e7ff">#application.i18nUtils.i18nTimeFormat(rc.now,rc..timeF,rc.thisTZ)#</td>
	</tr>
	<tr valign="top">
	<td align="right" valign="top"><b>i18nDateParse:</b></td>
	<td colspan="10" bgcolor="##b6e7ff">#application.i18nUtils.i18nDateParse(rc.tDate)# (original date: #rc.tDate#)</td>
	</tr>
	<tr valign="top">
	<td align="right" valign="top"><b>i18nDateTimeParse:</b></td>
	<td colspan="10" bgcolor="##b6e7ff">#application.i18nUtils.i18nDateTimeParse(rc.tDateTime)# (original datetime: #rc.tDateTime#)</td>
	</tr>
	<tr valign="top">
	<td align="right" valign="top"><b>getDateTimePattern:</b></td>
	<td colspan="10" bgcolor="##b6e7ff">#application.i18nUtils.getDateTimePattern()#</td>
	</tr>
	<tr valign="top">
	<td align="right" valign="top"><b>formatDateTime:</b></td>
	<td colspan="10" bgcolor="##b6e7ff">#application.i18nUtils.formatDateTime(rc.now,"d MMMM yyyy")# (using "d MMMM yyyy")</td>
	</tr>
	<tr valign="top">
	<td align="right" valign="top"><b>i18nDateDiff:</b></td>
	<td colspan="10" bgcolor="##b6e7ff">#application.i18nUtils.i18nDateDiff(rc.now,rc.laterOn,"day",rc.thisTZ)# day(s) (#rc.laterOn# #rc.now#, randomly generated end date)</td>
	</tr>
	<tr valign="top">
