...
<cfset latest = getValue("latest")>
<cfset todaysbest = getValue("todaysbest")>
<cfset thismonth = getValue("thismonth")>
<cfset thisyear = getValue("thisyear")>
<cfset top30 = getValue("top30")>
