...
<input type="hidden" name="event" value="#Context.getValue("xehRanksSave")#">
<input type="hidden" name="id" value="#Context.getValue("id")#">
<table width="100%" cellspacing=0 cellpadding=5 class="adminEditTable">
	<tr valign="top">
		<td align="right"><b>Name:</b></td>
		<td><input type="text" name="name" value="#Context.getValue("name","")#" size="50"></td>
	</tr>
	<tr valign="top">
		<td align="right"><b>Minimum Number of Posts:</b></td>
		<td><input type="text" name="minposts" value="#Context.getValue("minposts","")#" size="50"></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
