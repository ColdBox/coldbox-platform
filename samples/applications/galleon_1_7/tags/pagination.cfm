...
<cfif not caller.Context.valueExists("page") or not isNumeric(caller.Context.getValue("page")) or caller.Context.getValue("page") lte 0>
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr valign="top">
				...
				<cfif attributes.mode is "threads" or attributes.mode is "messages">
					<a href="index.cfm?event=#caller.Context.getValue("xehNewPost")#&forumid=#request.forum.id#"><img src="images/btn_new_topic.gif" width="71" height="19" alt="New Topic" title="New Topic" border="0"></a>
					<cfif attributes.mode is "messages">
						<cfif not caller.isLoggedOn()>
							<cfset thisPage = cgi.script_name & "?" & cgi.query_string & "&##newpost">
							<cfset link = "index.cfm?event=#caller.Context.getValue("xehLogin")#&ref=#urlEncodedFormat(thisPage)#">
				...
				<cfif caller.isLoggedOn() and attributes.mode is not "na">
					...
					<a href="index.cfm?event=#caller.Context.getValue("xehProfile")#&#qs#&s=1"><img src="images/btn_subscribe.gif" width="73" height="19" alt="Subscribe" title="Subscribe" border="0"></a>
				</cfif>
				...
				<cfif caller.Context.getValue("page") is 1>
					<img src="images/arrow_left_grey.gif" alt="Previous Page" width="17" height="17" align="absmiddle">
				<cfelse>
					<a href="#cgi.script_name#?#qs#&page=#caller.Context.getValue("page")-1#"><img src="images/arrow_left_active.gif" alt="Previous Page" width="17" height="17" border="0" align="absmiddle"></a>
				</cfif>
				<span class="pageText">&nbsp;Page:
				<cfloop index="x" from=1 to="#attributes.pages#">
					<cfif caller.Context.getValue("page") is not x><a href="#cgi.script_name#?#qs#&page=#x#">#x#</a><cfelse>#x#</cfif>
				</cfloop>
				&nbsp;</span>
				<cfif caller.Context.getValue("page") is attributes.pages>
					<img src="images/arrow_right_grey.gif" alt="Next Page" width="17" height="17" align="absmiddle">
				<cfelse>
					<a href="#cgi.script_name#?#qs#&page=#caller.Context.getValue("page") + 1#"><img src="images/arrow_right_active.gif" alt="Next Page" width="17" height="17" border="0" align="absmiddle"></a>
				</cfif>
				</td>
			</tr>
		</table>
