...
<body>
	<div id="banner">
		<div style="float:right">
			<form name="frmSearch" style="padding:0px;margin:5px;" method="post" action="javascript:doFormEvent('ehFeed.doSearchByTerm','centercontent',document.frmSearch);">
				<input type="text" name="searchTerm" value="" />
				<input type="submit" value="Search" />
			</form>
			<div id="divAccountActions"></div>
		</div>
		<h1>
	...
	<p align="center">ColdBoxReader is developed by <a href="http://www.wencho.net" target="_blank">Oscar Arevalo</a> to showcase AJAX-style interaction using the ColdBox Framework
</body>
</html>