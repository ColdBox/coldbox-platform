...
<cfset setBaseURL("http://jorteg.esri.com/simple_blog_4/index.cfm/")>
...
<cfset addCourse(pattern="entry/:id",handler="general",action="viewPost")>
<cfset addCourse(pattern="rss/:feedType",handler="general",action="rssEntries")>
