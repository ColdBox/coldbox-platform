...
<Config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
	...
	<Settings>
		...
		<Setting name="AppName"						value="simple_blog_4"/>
		...
		<Setting name="AppMapping"					value="/simple_blog_4"/>    
	...
	-->
	<YourSettings>
		<Setting name="TransferConfigPath"          value="/simple_blog_4/config/transfer.xml.cfm" />
  		<Setting name="TransferDefinitionsPath"     value="/simple_blog_4/config/definitions" />
  		<Setting name="TransferDSNAlias"            value="blogDSN" />
