<cfset qryFeeds = requestContext.getValue("qryData")>
<cfset tag = requestContext.getValue("tag")>
<cfset term = requestContext.getValue("term")>
...
<br>
	...
	<cfloop query="qryFeeds">
		<li><div style="line-height:20px;">
			<a href="javascript:doEvent('#requestContext.getValue("xehFeed")#','centercontent',{feedID:'#qryFeeds.feedID#'});"><strong>#qryFeeds.feedname#</strong></a>
	...
	<br>
	<script>
		doEvent("#requestContext.getValue("xehTags")#", "rightcontent1", {});
	</script>
</cfoutput>
