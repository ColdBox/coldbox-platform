<p style="line-height:20px;">
	...
	<cfif not Session.oUserBean.getVerified()>
		...
		To Add a Feed, your must first <a href="javascript:doEvent('#requestContext.getValue("xehLogin")#','centercontent',{})"><strong>Sign-in</strong></a> to your account
		or <a href="javascript:doEvent('#requestContext.getValue("xehSignup")#','centercontent',{})"><strong>Create an Account</strong></a>.
	<cfelse>
		<div style="margin-bottom:10px;">
	...
	<cfif Session.oUserBean.getVerified()>
		...
		<cfoutput>
			...
			<form name="frm" method="post" action="javascript:doFormEvent('#requestContext.getValue("xehUpdateProfile")#','leftcontent1',document.frm)">
			<p>
