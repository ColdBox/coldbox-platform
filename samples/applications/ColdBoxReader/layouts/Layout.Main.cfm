...
<body>
	<div id="banner">
		...
		<div id="statusbar">
			...
			<form name="frmSearch" style="padding:0px;margin:5px;" method="post" action="javascript:doFormEvent('#requestContext.getValue("xehSearch")#','centercontent',document.frmSearch);">
